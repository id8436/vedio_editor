...
.method protected static clearBeacon()V
    ...
    .prologue
    .line 70
    const-string/jumbo v0, "a.beacon.uuid"

    invoke-static {v0}, Lcom/adobe/mobile/TargetWorker;->removePersistentParameter(Ljava/lang/String;)V

    .line 71
    const-string/jumbo v0, "a.beacon.major"

    invoke-static {v0}, Lcom/adobe/mobile/TargetWorker;->removePersistentParameter(Ljava/lang/String;)V

    .line 72
    const-string/jumbo v0, "a.beacon.minor"

    invoke-static {v0}, Lcom/adobe/mobile/TargetWorker;->removePersistentParameter(Ljava/lang/String;)V

    .line 73
    const-string/jumbo v0, "a.beacon.prox"
...
.method protected static trackBeacon(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/adobe/mobile/Analytics$BEACON_PROXIMITY;Ljava/util/Map;)V
    ...
    .line 40
    const-string/jumbo v1, "a.beacon.uuid"
    ...
    .line 45
    const-string/jumbo v1, "a.beacon.major"
    ...
    .line 50
    const-string/jumbo v1, "a.beacon.minor"
    ...
    .line 55
    const-string/jumbo v1, "a.beacon.prox"
