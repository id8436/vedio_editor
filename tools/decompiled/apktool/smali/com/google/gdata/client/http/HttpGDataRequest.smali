...
.method protected constructor <init>(Lcom/google/gdata/client/Service$GDataRequest$RequestType;Ljava/net/URL;Lcom/google/gdata/util/ContentType;Lcom/google/gdata/client/http/HttpAuthToken;Ljava/util/Map;Ljava/util/Map;Lcom/google/gdata/client/http/HttpUrlConnectionSource;)V
    ...
    iput-object v0, p0, Lcom/google/gdata/client/http/HttpGDataRequest;->httpConn:Ljava/net/HttpURLConnection;
    ...
    .line 287
    :pswitch_0
    iput-boolean v2, p0, Lcom/google/gdata/client/http/HttpGDataRequest;->hasOutput:Z
    ...
    invoke-interface {p4, p2, v0}, Lcom/google/gdata/client/http/HttpAuthToken;->getAuthorizationHeader(Ljava/net/URL;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v1, v0}, Lcom/google/gdata/client/http/HttpGDataRequest;->setPrivateHeader(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1, v0}, Lcom/google/gdata/client/http/HttpGDataRequest;->setHeader(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_1

    .line 292
    :pswitch_1
    iput-boolean v2, p0, Lcom/google/gdata/client/http/HttpGDataRequest;->expectsInput:Z
    ...
    invoke-virtual {p0, v0}, Lcom/google/gdata/client/http/HttpGDataRequest;->setMethod(Ljava/lang/String;)V
    ...
    .line 301
    const-string/jumbo v0, "com.google.gdata.UseMethodOverride"
    ...
    .line 303
    const-string/jumbo v0, "X-HTTP-Method-Override"
    ...
    iget-boolean v1, p0, Lcom/google/gdata/client/http/HttpGDataRequest;->expectsInput:Z
...
.method private isOAuthProxyErrorResponse()Z
    ...
    .line 567
    const-string/jumbo v3, "x_oauth_approval_url"
    ...
    .line 569
    iget-object v4, p0, Lcom/google/gdata/client/http/HttpGDataRequest;->httpConn:Ljava/net/HttpURLConnection;
    ...
    const-string/jumbo v4, "x_oauth_error"
    ...
    const-string/jumbo v4, "x_oauth_error_text"
...
.method public end()V
    ...
    const-string/jumbo v3, "Error closing response stream"
...
.method public execute()V
    ...
    .prologue
    .line 492
    iget v0, p0, Lcom/google/gdata/client/http/HttpGDataRequest;->connectTimeout:I
    ...
    iget v1, p0, Lcom/google/gdata/client/http/HttpGDataRequest;->connectTimeout:I

    invoke-virtual {v0, v1}, Ljava/net/HttpURLConnection;->setConnectTimeout(I)V

    .line 496
    :cond_0
    iget v0, p0, Lcom/google/gdata/client/http/HttpGDataRequest;->readTimeout:I
    ...
    iget v1, p0, Lcom/google/gdata/client/http/HttpGDataRequest;->readTimeout:I

    invoke-virtual {v0, v1}, Ljava/net/HttpURLConnection;->setReadTimeout(I)V

    .line 507
    :cond_1
    const-string/jumbo v0, "http.strictPostRedirect"
    ...
    iget-object v1, p0, Lcom/google/gdata/client/http/HttpGDataRequest;->requestUrl:Ljava/net/URL;
    ...
    .line 542
    const-string/jumbo v1, "http.strictPostRedirect"
...
.method protected getRequestConnection(Ljava/net/URL;)Ljava/net/HttpURLConnection;
    ...
    .line 386
    :try_start_0
    iget-object v0, p0, Lcom/google/gdata/client/http/HttpGDataRequest;->connectionSource:Lcom/google/gdata/client/http/HttpUrlConnectionSource;

    invoke-interface {v0, p1}, Lcom/google/gdata/client/http/HttpUrlConnectionSource;->openConnection(Ljava/net/URL;)Ljava/net/HttpURLConnection;
    :try_end_0
...
.method public getRequestStream()Ljava/io/OutputStream;
    ...
    const-string/jumbo v1, "Request doesn\'t accept input"
...
.method public getResponseContentType()Lcom/google/gdata/util/ContentType;
    ...
    const-string/jumbo v1, "Must call execute() before attempting to read response"
...
.method public getResponseDateHeader(Ljava/lang/String;)Lcom/google/gdata/data/DateTime;
    ...
    invoke-virtual {v0, p1, v2, v3}, Ljava/net/HttpURLConnection;->getHeaderFieldDate(Ljava/lang/String;J)J
...
.method public getResponseStream()Ljava/io/InputStream;
    ...
    const-string/jumbo v1, "Request doesn\'t have response data"
...
.method public setEtag(Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "Etag conditions not supported for this request type"
...
.method public setIfModifiedSince(Lcom/google/gdata/data/DateTime;)V
    ...
    const-string/jumbo v1, "Date conditions not supported for this request type"
