...
.method public getAccessToken(Lcom/google/gdata/client/authn/oauth/OAuthParameters;)Ljava/lang/String;
    ...
    invoke-direct {v0, v1, p1}, Lcom/google/gdata/client/authn/oauth/TwoLeggedOAuthHelper;-><init>(Lcom/google/gdata/client/authn/oauth/OAuthSigner;Lcom/google/gdata/client/authn/oauth/OAuthParameters;)V
    ...
    .line 550
    iget-object v0, p0, Lcom/google/gdata/client/authn/oauth/OAuthHelper;->signer:Lcom/google/gdata/client/authn/oauth/OAuthSigner;
    ...
    invoke-virtual {p0, v0, v1, p1}, Lcom/google/gdata/client/authn/oauth/OAuthHelper;->getOAuthUrl(Ljava/lang/String;Ljava/lang/String;Lcom/google/gdata/client/authn/oauth/OAuthParameters;)Ljava/net/URL;

    move-result-object v0

    .line 559
    iget-object v1, p0, Lcom/google/gdata/client/authn/oauth/OAuthHelper;->httpClient:Lcom/google/gdata/client/authn/oauth/OAuthHttpClient;

    invoke-virtual {v1, v0}, Lcom/google/gdata/client/authn/oauth/OAuthHttpClient;->getResponse(Ljava/net/URL;)Ljava/lang/String;

    move-result-object v0

    .line 560
    invoke-static {v0}, Lcom/google/gdata/client/authn/oauth/OAuthUtil;->parseQuerystring(Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-virtual {p1, v0}, Lcom/google/gdata/client/authn/oauth/OAuthParameters;->setOAuthToken(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v0}, Lcom/google/gdata/client/authn/oauth/OAuthParameters;->setOAuthTokenSecret(Ljava/lang/String;)V
...
.method public getOAuthParametersFromCallback(Ljava/lang/String;Lcom/google/gdata/client/authn/oauth/OAuthParameters;)V
    ...
    invoke-virtual {p2, v0}, Lcom/google/gdata/client/authn/oauth/OAuthParameters;->setOAuthToken(Ljava/lang/String;)V
    ...
    invoke-virtual {p2, v0}, Lcom/google/gdata/client/authn/oauth/OAuthParameters;->setOAuthTokenSecret(Ljava/lang/String;)V
    ...
    invoke-virtual {p2, v0}, Lcom/google/gdata/client/authn/oauth/OAuthParameters;->setOAuthVerifier(Ljava/lang/String;)V
...
.method public getOAuthUrl(Ljava/lang/String;Ljava/lang/String;Lcom/google/gdata/client/authn/oauth/OAuthParameters;)Ljava/net/URL;
    ...
    .line 661
    invoke-virtual {v0, p1, p2}, Lcom/google/gdata/client/authn/oauth/TwoLeggedOAuthHelper;->addCommonRequestParameters(Ljava/lang/String;Ljava/lang/String;)V

    .line 664
    new-instance v2, Lcom/google/gdata/client/authn/oauth/OAuthHelper$QueryKeyValuePair;

    invoke-direct {v2}, Lcom/google/gdata/client/authn/oauth/OAuthHelper$QueryKeyValuePair;-><init>()V
...
.method public getUnauthorizedRequestToken(Lcom/google/gdata/client/authn/oauth/OAuthParameters;)V
    ...
    invoke-virtual {p1, v1, v0}, Lcom/google/gdata/client/authn/oauth/OAuthParameters;->addCustomBaseParameter(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, v2, p1}, Lcom/google/gdata/client/authn/oauth/OAuthHelper;->getOAuthUrl(Ljava/lang/String;Ljava/lang/String;Lcom/google/gdata/client/authn/oauth/OAuthParameters;)Ljava/net/URL;
    ...
    invoke-virtual {v2, v0}, Lcom/google/gdata/client/authn/oauth/OAuthHttpClient;->getResponse(Ljava/net/URL;)Ljava/lang/String;
    ...
    invoke-virtual {p1, v0}, Lcom/google/gdata/client/authn/oauth/OAuthParameters;->removeCustomBaseParameter(Ljava/lang/String;)V
...
.method public revokeToken(Lcom/google/gdata/client/authn/oauth/OAuthParameters;)V
    ...
    iget-object v2, p0, Lcom/google/gdata/client/authn/oauth/OAuthHelper;->revokeTokenUrl:Ljava/lang/String;

    const-string/jumbo v3, "GET"

    invoke-virtual {p0, v2, v3, p1}, Lcom/google/gdata/client/authn/oauth/OAuthHelper;->getAuthorizationHeader(Ljava/lang/String;Ljava/lang/String;Lcom/google/gdata/client/authn/oauth/OAuthParameters;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v2, v0}, Lcom/google/gdata/client/authn/oauth/OAuthHttpClient;->getResponse(Ljava/net/URL;Ljava/util/Map;)Ljava/lang/String;
    :try_end_0
    .catch Ljava/net/MalformedURLException; {:try_start_0 .. :try_end_0} :catch_0
