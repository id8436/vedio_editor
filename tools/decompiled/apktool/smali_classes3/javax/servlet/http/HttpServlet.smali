...
.method private getAllDeclaredMethods(Ljava/lang/Class;)[Ljava/lang/reflect/Method;
    ...
    .line 484
    sget-object v0, Ljavax/servlet/http/HttpServlet;->class$javax$servlet$http$HttpServlet:Ljava/lang/Class;

    if-nez v0, :cond_0

    const-string/jumbo v0, "javax.servlet.http.HttpServlet"

    invoke-static {v0}, Ljavax/servlet/http/HttpServlet;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v0

    sput-object v0, Ljavax/servlet/http/HttpServlet;->class$javax$servlet$http$HttpServlet:Ljava/lang/Class;
...
.method protected doDelete(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)V
    ...
    .line 470
    sget-object v1, Ljavax/servlet/http/HttpServlet;->lStrings:Ljava/util/ResourceBundle;

    const-string/jumbo v2, "http.method_delete_not_supported"
...
.method protected doGet(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)V
    ...
    const-string/jumbo v2, "http.method_get_not_supported"
...
.method protected doOptions(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)V
    ...
    invoke-direct {p0, v1}, Ljavax/servlet/http/HttpServlet;->getAllDeclaredMethods(Ljava/lang/Class;)[Ljava/lang/reflect/Method;
    ...
    const-string/jumbo v9, "doDelete"
    ...
    invoke-interface {p2, v1, v0}, Ljavax/servlet/http/HttpServletResponse;->setHeader(Ljava/lang/String;Ljava/lang/String;)V
...
.method protected doPost(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)V
    ...
    const-string/jumbo v2, "http.method_post_not_supported"
...
.method protected doPut(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)V
    ...
    const-string/jumbo v2, "http.method_put_not_supported"
...
.method protected doTrace(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)V
    ...
    .line 653
    const-string/jumbo v2, "message/http"
    ...
    .line 656
    invoke-virtual {v1, v0}, Ljavax/servlet/ServletOutputStream;->print(Ljava/lang/String;)V
...
.method public service(Ljavax/servlet/ServletRequest;Ljavax/servlet/ServletResponse;)V
    ...
    const-string/jumbo v1, "non-HTTP request or response"
...
.method protected service(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)V
    ...
    const-string/jumbo v2, "http.method_not_implemented"
