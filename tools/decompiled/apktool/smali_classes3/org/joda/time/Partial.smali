...
.method public constructor <init>(Lorg/joda/time/DateTimeFieldType;ILorg/joda/time/Chronology;)V
    ...
    const-string/jumbo v1, "The field type must not be null"
...
.method public constructor <init>(Lorg/joda/time/ReadablePartial;)V
    ...
    const-string/jumbo v1, "The partial must not be null"
...
.method public constructor <init>([Lorg/joda/time/DateTimeFieldType;[ILorg/joda/time/Chronology;)V
    ...
    const-string/jumbo v1, "Types array must not be null"
    ...
    const-string/jumbo v1, "Values array must not be null"
    ...
    const-string/jumbo v1, "Values array must be the same length as the types array"
    ...
    const-string/jumbo v3, "Types array must not contain null: index "
    ...
    const-string/jumbo v3, "Types array must be in order largest-smallest: "
    ...
    const-string/jumbo v3, "Types array must not contain duplicate unsupported: "
    ...
    const-string/jumbo v3, "Types array must not contain duplicate: "
    ...
    const-string/jumbo v3, "Types array must be in order largest-smallest, for year-based fields, years is defined as being largest: "
