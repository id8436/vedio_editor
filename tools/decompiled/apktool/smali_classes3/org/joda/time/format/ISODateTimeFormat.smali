...
.method private static checkNotStrictISO(Ljava/util/Collection;Z)V
    ...
    const-string/jumbo v2, "No valid ISO8601 format for fields: "
...
.method public static forFields(Ljava/util/Collection;ZZ)Lorg/joda/time/format/DateTimeFormatter;
    ...
    const-string/jumbo v1, "The fields must not be null or empty"
    ...
    const-string/jumbo v2, "No valid format for fields: "
...
.method private static time(Lorg/joda/time/format/DateTimeFormatterBuilder;Ljava/util/Collection;ZZZZ)V
    ...
    const-string/jumbo v2, "No valid ISO8601 format for fields because Date was reduced precision: "
    ...
    const-string/jumbo v2, "No valid ISO8601 format for fields because Time was truncated: "
