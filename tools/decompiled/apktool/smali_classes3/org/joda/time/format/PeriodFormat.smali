...
.method private static buildNonRegExFormatter(Ljava/util/ResourceBundle;Ljava/util/Locale;)Lorg/joda/time/format/PeriodFormatter;
    ...
    const-string/jumbo v2, "PeriodFormat.commaspace"

    invoke-virtual {p0, v2}, Ljava/util/ResourceBundle;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    const-string/jumbo v3, "PeriodFormat.spaceandspace"
    ...
    const-string/jumbo v2, "PeriodFormat.month"

    invoke-virtual {p0, v2}, Ljava/util/ResourceBundle;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    const-string/jumbo v3, "PeriodFormat.months"
    ...
    const-string/jumbo v2, "PeriodFormat.week"

    invoke-virtual {p0, v2}, Ljava/util/ResourceBundle;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    const-string/jumbo v3, "PeriodFormat.weeks"
    ...
    const-string/jumbo v2, "PeriodFormat.day"

    invoke-virtual {p0, v2}, Ljava/util/ResourceBundle;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    const-string/jumbo v3, "PeriodFormat.days"
    ...
    const-string/jumbo v2, "PeriodFormat.hour"

    invoke-virtual {p0, v2}, Ljava/util/ResourceBundle;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    const-string/jumbo v3, "PeriodFormat.hours"
    ...
    const-string/jumbo v2, "PeriodFormat.minute"

    invoke-virtual {p0, v2}, Ljava/util/ResourceBundle;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    const-string/jumbo v3, "PeriodFormat.minutes"
    ...
    const-string/jumbo v2, "PeriodFormat.second"

    invoke-virtual {p0, v2}, Ljava/util/ResourceBundle;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    const-string/jumbo v3, "PeriodFormat.seconds"
    ...
    const-string/jumbo v1, "PeriodFormat.millisecond"

    invoke-virtual {p0, v1}, Ljava/util/ResourceBundle;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    const-string/jumbo v2, "PeriodFormat.milliseconds"
...
.method private static buildRegExFormatter(Ljava/util/ResourceBundle;Ljava/util/Locale;)Lorg/joda/time/format/PeriodFormatter;
    ...
    .line 227
    const-string/jumbo v1, "PeriodFormat.regex.separator"
    ...
    .line 231
    const-string/jumbo v3, "PeriodFormat.years.regex"
    ...
    const-string/jumbo v4, "PeriodFormat.years.list"
    ...
    .line 239
    :goto_0
    const-string/jumbo v3, "PeriodFormat.commaspace"

    invoke-virtual {p0, v3}, Ljava/util/ResourceBundle;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    const-string/jumbo v4, "PeriodFormat.spaceandspace"
    ...
    .line 241
    const-string/jumbo v3, "PeriodFormat.months.regex"
    ...
    const-string/jumbo v4, "PeriodFormat.months.list"
    ...
    .line 251
    const-string/jumbo v3, "PeriodFormat.weeks.regex"
    ...
    const-string/jumbo v4, "PeriodFormat.weeks.list"
    ...
    .line 261
    const-string/jumbo v3, "PeriodFormat.days.regex"
    ...
    const-string/jumbo v4, "PeriodFormat.days.list"
    ...
    .line 271
    const-string/jumbo v3, "PeriodFormat.hours.regex"
    ...
    const-string/jumbo v4, "PeriodFormat.hours.list"
    ...
    .line 281
    const-string/jumbo v3, "PeriodFormat.minutes.regex"
    ...
    const-string/jumbo v4, "PeriodFormat.minutes.list"
    ...
    .line 291
    const-string/jumbo v3, "PeriodFormat.seconds.regex"
    ...
    const-string/jumbo v4, "PeriodFormat.seconds.list"
    ...
    .line 301
    const-string/jumbo v0, "PeriodFormat.milliseconds.regex"
    ...
    const-string/jumbo v3, "PeriodFormat.milliseconds.list"
    ...
    .line 236
    :cond_0
    const-string/jumbo v3, "PeriodFormat.year"

    invoke-virtual {p0, v3}, Ljava/util/ResourceBundle;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    const-string/jumbo v4, "PeriodFormat.years"
    ...
    .line 246
    :cond_1
    const-string/jumbo v3, "PeriodFormat.month"

    invoke-virtual {p0, v3}, Ljava/util/ResourceBundle;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    const-string/jumbo v4, "PeriodFormat.months"
    ...
    .line 256
    :cond_2
    const-string/jumbo v3, "PeriodFormat.week"

    invoke-virtual {p0, v3}, Ljava/util/ResourceBundle;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    const-string/jumbo v4, "PeriodFormat.weeks"
    ...
    .line 266
    :cond_3
    const-string/jumbo v3, "PeriodFormat.day"

    invoke-virtual {p0, v3}, Ljava/util/ResourceBundle;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    const-string/jumbo v4, "PeriodFormat.days"
    ...
    .line 276
    :cond_4
    const-string/jumbo v3, "PeriodFormat.hour"

    invoke-virtual {p0, v3}, Ljava/util/ResourceBundle;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    const-string/jumbo v4, "PeriodFormat.hours"
    ...
    .line 286
    :cond_5
    const-string/jumbo v3, "PeriodFormat.minute"

    invoke-virtual {p0, v3}, Ljava/util/ResourceBundle;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    const-string/jumbo v4, "PeriodFormat.minutes"
    ...
    .line 296
    :cond_6
    const-string/jumbo v3, "PeriodFormat.second"

    invoke-virtual {p0, v3}, Ljava/util/ResourceBundle;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    const-string/jumbo v4, "PeriodFormat.seconds"
    ...
    .line 306
    :cond_7
    const-string/jumbo v0, "PeriodFormat.millisecond"

    invoke-virtual {p0, v0}, Ljava/util/ResourceBundle;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    const-string/jumbo v1, "PeriodFormat.milliseconds"
...
.method private static buildWordBased(Ljava/util/Locale;)Lorg/joda/time/format/PeriodFormatter;
    ...
    .prologue
    .line 217
    const-string/jumbo v0, "org.joda.time.format.messages"
...
.method private static retrieveVariants(Ljava/util/ResourceBundle;)[Ljava/lang/String;
    ...
    const-string/jumbo v2, "PeriodFormat.space"
    ...
    const-string/jumbo v2, "PeriodFormat.comma"
    ...
    const-string/jumbo v2, "PeriodFormat.commandand"
    ...
    const-string/jumbo v2, "PeriodFormat.commaspaceand"
