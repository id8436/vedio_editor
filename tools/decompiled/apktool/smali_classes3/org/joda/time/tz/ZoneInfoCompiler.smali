...
.method private static printUsage()V
    ...
    const-string/jumbo v1, "Usage: java org.joda.time.tz.ZoneInfoCompiler <options> <source files>"
    ...
    const-string/jumbo v1, "where possible options include:"
    ...
    const-string/jumbo v1, "  -src <directory>    Specify where to read source files"
    ...
    const-string/jumbo v1, "  -dst <directory>    Specify where to write generated files"
    ...
    const-string/jumbo v1, "  -verbose            Output verbosely (default false)"
...
.method static test(Ljava/lang/String;Lorg/joda/time/DateTimeZone;)Z
    ...
    const-string/jumbo v2, "*d* Error in "
    ...
    const-string/jumbo v3, "*s* Error in "
    ...
    const-string/jumbo v6, "*r* Error in "
...
.method private writeZone(Ljava/io/File;Lorg/joda/time/tz/DateTimeZoneBuilder;Lorg/joda/time/DateTimeZone;)V
    ...
    const-string/jumbo v2, "*e* Error in "
    ...
    const-string/jumbo v2, ": Didn\'t read properly from file"
...
.method static writeZoneInfoMap(Ljava/io/DataOutputStream;Ljava/util/Map;)V
    ...
    const-string/jumbo v1, "Too many time zone ids"
...
.method public compile(Ljava/io/File;[Ljava/io/File;)Ljava/util/Map;
    ...
    const-string/jumbo v2, "Destination directory doesn\'t exist and cannot be created: "
    ...
    const-string/jumbo v2, "Destination is not a directory: "
    ...
    const-string/jumbo v1, "Writing zoneinfo files"
    ...
    const-string/jumbo v8, "Cannot find source zone \'"
    ...
    const-string/jumbo v7, "\' to link alias \'"
    ...
    const-string/jumbo v8, "Good link: "
    ...
    const-string/jumbo v8, "Cannot find time zone \'"
    ...
    const-string/jumbo v8, "Back link: "
    ...
    const-string/jumbo v1, "Writing ZoneInfoMap"
    ...
    const-string/jumbo v1, "ZoneInfoMap"
...
.method public parseDataFile(Ljava/io/BufferedReader;Z)V
    ...
    const-string/jumbo v1, "Attempting to create a Zone from an incomplete tokenizer"
    ...
    const-string/jumbo v3, "US/Pacific-New"
    ...
    const-string/jumbo v4, "Unknown line: "
