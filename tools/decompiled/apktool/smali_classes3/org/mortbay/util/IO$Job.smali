...
.method public run()V
    ...
    .line 97
    :try_start_0
    iget-object v0, p0, Lorg/mortbay/util/IO$Job;->in:Ljava/io/InputStream;
    ...
    iget-object v1, p0, Lorg/mortbay/util/IO$Job;->out:Ljava/io/OutputStream;
    ...
    .line 100
    :cond_1
    iget-object v0, p0, Lorg/mortbay/util/IO$Job;->read:Ljava/io/Reader;

    iget-object v1, p0, Lorg/mortbay/util/IO$Job;->write:Ljava/io/Writer;

    const-wide/16 v2, -0x1

    invoke-static {v0, v1, v2, v3}, Lorg/mortbay/util/IO;->copy(Ljava/io/Reader;Ljava/io/Writer;J)V
    :try_end_0
    ...
    .line 106
    :try_start_1
    iget-object v0, p0, Lorg/mortbay/util/IO$Job;->out:Ljava/io/OutputStream;
    ...
    .line 108
    :cond_2
    iget-object v0, p0, Lorg/mortbay/util/IO$Job;->write:Ljava/io/Writer;
