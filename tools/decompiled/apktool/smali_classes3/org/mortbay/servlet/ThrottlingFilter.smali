...
.method private getIntegerParameter(Ljavax/servlet/FilterConfig;Ljava/lang/String;I)I
    ...
    const-string/jumbo v3, " must be a number (was "
...
.method private popQueue()V
    ...
    .line 202
    const-string/jumbo v1, "Resuming continuation {}"
...
.method private queueRequest(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Lorg/mortbay/util/ajax/Continuation;)Z
    ...
    .line 234
    const-string/jumbo v0, "Queue is full, rejecting request {}"
    ...
    .line 238
    :cond_0
    const-string/jumbo v0, "Queuing request {} / {}"
    ...
    .line 243
    const-string/jumbo v0, "Resuming blocking continuation for request {}"
...
.method public doFilter(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Ljavax/servlet/FilterChain;)V
    ...
    .line 152
    const-string/jumbo v2, "Request {} / {} was already queued, rejecting"

    invoke-interface {p1}, Ljavax/servlet/http/HttpServletRequest;->getRequestURI()Ljava/lang/String;

    move-result-object v3

    invoke-static {v2, v3, v0}, Lorg/mortbay/log/Log;->debug(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V

    .line 153
    invoke-direct {p0, v0}, Lorg/mortbay/servlet/ThrottlingFilter;->dropFromQueue(Lorg/mortbay/util/ajax/Continuation;)V
    ...
    :cond_2
    :try_start_1
    invoke-direct {p0, p1, p2, v0}, Lorg/mortbay/servlet/ThrottlingFilter;->queueRequest(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Lorg/mortbay/util/ajax/Continuation;)Z
...
.method public init(Ljavax/servlet/FilterConfig;)V
    ...
    const-string/jumbo v1, "Config{maximum:"
...
.method protected rejectRequest(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)V
    ...
    const-string/jumbo v2, "Too many active connections to resource "
