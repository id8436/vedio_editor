...
.method public static getDefaultDescription(Ljava/lang/Class;)Lcom/google/gdata/data/ExtensionDescription;
    ...
    check-cast v1, Lcom/google/gdata/data/ExtensionDescription$Default;
    ...
    const-string/jumbo v2, "No default description found for "
    ...
    invoke-interface {v1}, Lcom/google/gdata/data/ExtensionDescription$Default;->nsAlias()Ljava/lang/String;

    move-result-object v3

    invoke-interface {v1}, Lcom/google/gdata/data/ExtensionDescription$Default;->nsUri()Ljava/lang/String;

    move-result-object v4

    invoke-direct {v2, v3, v4}, Lcom/google/gdata/util/common/xml/XmlNamespace;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-interface {v1}, Lcom/google/gdata/data/ExtensionDescription$Default;->localName()Ljava/lang/String;

    move-result-object v3

    invoke-interface {v1}, Lcom/google/gdata/data/ExtensionDescription$Default;->isRequired()Z

    move-result v4

    invoke-interface {v1}, Lcom/google/gdata/data/ExtensionDescription$Default;->isRepeatable()Z

    move-result v5

    invoke-interface {v1}, Lcom/google/gdata/data/ExtensionDescription$Default;->isAggregate()Z

    move-result v6

    invoke-interface {v1}, Lcom/google/gdata/data/ExtensionDescription$Default;->allowsArbitraryXml()Z

    move-result v7

    invoke-interface {v1}, Lcom/google/gdata/data/ExtensionDescription$Default;->allowsMixedContent()Z
...
.method public compareTo(Lcom/google/gdata/data/ExtensionDescription;)I
    ...
    .line 295
    :cond_0
    iget-object v1, p1, Lcom/google/gdata/data/ExtensionDescription;->namespace:Lcom/google/gdata/util/common/xml/XmlNamespace;
    ...
    iget-object v1, p1, Lcom/google/gdata/data/ExtensionDescription;->localName:Ljava/lang/String;
...
.method public generateConfig(Lcom/google/gdata/util/common/xml/XmlWriter;Lcom/google/gdata/data/ExtensionProfile;)V
    ...
    const-string/jumbo v1, "extensionClass"
    ...
    const-string/jumbo v1, "arbitraryXml"
    ...
    const-string/jumbo v3, "extensionDescription"
    ...
    const-string/jumbo v1, "extensionDescription"
