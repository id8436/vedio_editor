...
.method private getGoogleAuthTokenFactory()Lcom/google/gdata/client/GoogleAuthTokenFactory;
    ...
    const-string/jumbo v1, "Invalid authentication token factory"
...
.method protected createRequest(Lcom/google/gdata/client/Query;Lcom/google/gdata/util/ContentType;)Lcom/google/gdata/client/Service$GDataRequest;
    ...
    .line 550
    instance-of v0, v1, Lcom/google/gdata/client/http/GoogleGDataRequest;
    ...
    .line 551
    check-cast v0, Lcom/google/gdata/client/http/GoogleGDataRequest;

    invoke-virtual {v0, p0}, Lcom/google/gdata/client/http/GoogleGDataRequest;->setService(Lcom/google/gdata/client/GoogleService;)V
...
.method public getCookies()Ljava/util/Set;
    ...
    const-string/jumbo v1, "No cookie manager defined"
...
.method public getFeed(Lcom/google/gdata/client/Query;Ljava/lang/Class;Lcom/google/gdata/data/DateTime;)Lcom/google/gdata/data/IFeed;
    ...
    invoke-direct {p1, v0}, Lcom/google/gdata/client/Query;-><init>(Ljava/net/URL;)V
...
.method protected handleRedirectException(Lcom/google/gdata/util/RedirectRequiredException;)Ljava/net/URL;
    ...
    iget-object v1, v1, Lcom/google/gdata/client/CoreErrorDomain;->invalidRedirectedToUrl:Lcom/google/gdata/util/ErrorDomain$ErrorCode;
    ...
    const-string/jumbo v2, "Invalid redirected-to URL - "
    ...
    invoke-virtual {v0, v1}, Lcom/google/gdata/util/ServiceException;->setInternalReason(Ljava/lang/String;)V
...
.method public setAuthSubToken(Ljava/lang/String;Ljava/security/PrivateKey;)V
    ...
    iget-object v1, p0, Lcom/google/gdata/client/GoogleService;->authTokenFactory:Lcom/google/gdata/client/AuthTokenFactory;

    invoke-interface {v1}, Lcom/google/gdata/client/AuthTokenFactory;->getAuthToken()Lcom/google/gdata/client/AuthTokenFactory$AuthToken;

    move-result-object v1

    invoke-interface {v0, v1}, Lcom/google/gdata/client/Service$GDataRequestFactory;->setAuthToken(Lcom/google/gdata/client/AuthTokenFactory$AuthToken;)V
