...
.method public addCustomParameter(Lcom/google/gdata/client/Query$CustomParameter;)V
    ...
    const-string/jumbo v1, "Null custom parameter"
...
.method public getCustomParameters(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 672
    invoke-static {v0}, Lcom/google/gdata/client/Query$CustomParameter;->access$000(Lcom/google/gdata/client/Query$CustomParameter;)Ljava/lang/String;
...
.method public getQueryUri()Ljava/net/URI;
    ...
    const-string/jumbo v1, "Unsupported Query"
    ...
    invoke-interface {v3, v0}, Lcom/google/gdata/util/common/base/Escaper;->escape(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v2, "Unable to encode query URI"
    ...
    iget-object v4, p0, Lcom/google/gdata/client/Query;->queryString:Ljava/lang/String;

    invoke-interface {v3, v4}, Lcom/google/gdata/util/common/base/Escaper;->escape(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {p0, v2, v0, v3}, Lcom/google/gdata/client/Query;->appendQueryParameter(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v4, p0, Lcom/google/gdata/client/Query;->author:Ljava/lang/String;
    ...
    sget-object v3, Lcom/google/gdata/client/Query$ResultFormat;->DEFAULT:Lcom/google/gdata/client/Query$ResultFormat;
    ...
    iget-object v3, p0, Lcom/google/gdata/client/Query;->resultFormat:Lcom/google/gdata/client/Query$ResultFormat;

    invoke-virtual {v3}, Lcom/google/gdata/client/Query$ResultFormat;->paramValue()Ljava/lang/String;
    ...
    .line 750
    const-string/jumbo v0, "updated-min"

    invoke-static {}, Lcom/google/gdata/util/common/base/CharEscapers;->uriEscaper()Lcom/google/gdata/util/common/base/Escaper;

    move-result-object v3

    iget-object v4, p0, Lcom/google/gdata/client/Query;->updatedMin:Lcom/google/gdata/data/DateTime;

    invoke-virtual {v4}, Lcom/google/gdata/data/DateTime;->toString()Ljava/lang/String;
    ...
    .line 755
    const-string/jumbo v0, "updated-max"

    invoke-static {}, Lcom/google/gdata/util/common/base/CharEscapers;->uriEscaper()Lcom/google/gdata/util/common/base/Escaper;

    move-result-object v3

    iget-object v4, p0, Lcom/google/gdata/client/Query;->updatedMax:Lcom/google/gdata/data/DateTime;
    ...
    .line 760
    const-string/jumbo v0, "published-min"

    invoke-static {}, Lcom/google/gdata/util/common/base/CharEscapers;->uriEscaper()Lcom/google/gdata/util/common/base/Escaper;

    move-result-object v3

    iget-object v4, p0, Lcom/google/gdata/client/Query;->publishedMin:Lcom/google/gdata/data/DateTime;
    ...
    .line 765
    const-string/jumbo v0, "published-max"

    invoke-static {}, Lcom/google/gdata/util/common/base/CharEscapers;->uriEscaper()Lcom/google/gdata/util/common/base/Escaper;

    move-result-object v3

    iget-object v4, p0, Lcom/google/gdata/client/Query;->publishedMax:Lcom/google/gdata/data/DateTime;
    ...
    iget v3, p0, Lcom/google/gdata/client/Query;->startIndex:I
    ...
    .line 775
    const-string/jumbo v0, "max-results"

    iget v3, p0, Lcom/google/gdata/client/Query;->maxResults:I
    ...
    iget-object v4, p0, Lcom/google/gdata/client/Query;->fields:Ljava/lang/String;
    ...
    invoke-interface {v4, v5}, Lcom/google/gdata/util/common/base/Escaper;->escape(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/google/gdata/client/Query$CustomParameter;->access$100(Lcom/google/gdata/client/Query$CustomParameter;)Ljava/lang/String;

    move-result-object v0

    invoke-interface {v5, v0}, Lcom/google/gdata/util/common/base/Escaper;->escape(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0, v2, v4, v0}, Lcom/google/gdata/client/Query;->appendQueryParameter(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    ...
    const-string/jumbo v2, "Unable to construct query URI"
...
.method public getUrl()Ljava/net/URL;
    ...
    .line 827
    :cond_0
    iget-object v1, p0, Lcom/google/gdata/client/Query;->feedUrl:Ljava/net/URL;
    ...
    const-string/jumbo v2, "Unable to create query URL"
...
.method public setMaxResults(I)V
    ...
    const-string/jumbo v1, "Max results must be zero or larger"
...
.method public setStartIndex(I)V
    ...
    const-string/jumbo v1, "Start index must be positive"
