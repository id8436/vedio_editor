...
# static fields
.field private static final zzRR:Ljava/lang/Object;

.field private static zzRS:Ljava/util/HashSet;
...
.field private static zzRT:Lcom/google/android/gms/common/images/ImageManager;

.field private static zzRU:Lcom/google/android/gms/common/images/ImageManager;
...
.field private final zzRV:Ljava/util/concurrent/ExecutorService;

.field private final zzRW:Lcom/google/android/gms/common/images/ImageManager$zzb;

.field private final zzRX:Lcom/google/android/gms/internal/zzhg;
...
.field private final zzRZ:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map",
            "<",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/common/images/ImageManager;->zzRR:Ljava/lang/Object;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    sput-object v0, Lcom/google/android/gms/common/images/ImageManager;->zzRS:Ljava/util/HashSet;
...
.method private constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->zzRV:Ljava/util/concurrent/ExecutorService;
    ...
    invoke-direct {p0}, Lcom/google/android/gms/common/images/ImageManager;->zzlw()V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->zzRX:Lcom/google/android/gms/internal/zzhg;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->zzRY:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->zzRZ:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->zzSa:Ljava/util/Map;
...
.method private zza(Lcom/google/android/gms/common/images/zza$zza;)Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->zzRW:Lcom/google/android/gms/common/images/ImageManager$zzb;
...
.method static synthetic zza(Lcom/google/android/gms/common/images/ImageManager;)Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->zzRY:Ljava/util/Map;
...
.method public static zzb(Landroid/content/Context;Z)Lcom/google/android/gms/common/images/ImageManager;
    ...
    sget-object v0, Lcom/google/android/gms/common/images/ImageManager;->zzRU:Lcom/google/android/gms/common/images/ImageManager;
    ...
    sput-object v0, Lcom/google/android/gms/common/images/ImageManager;->zzRU:Lcom/google/android/gms/common/images/ImageManager;
    ...
    :cond_1
    sget-object v0, Lcom/google/android/gms/common/images/ImageManager;->zzRT:Lcom/google/android/gms/common/images/ImageManager;
    ...
    sput-object v0, Lcom/google/android/gms/common/images/ImageManager;->zzRT:Lcom/google/android/gms/common/images/ImageManager;
...
.method static synthetic zzc(Lcom/google/android/gms/common/images/ImageManager;)Lcom/google/android/gms/internal/zzhg;
    .locals 1

    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->zzRX:Lcom/google/android/gms/internal/zzhg;
...
.method static synthetic zzd(Lcom/google/android/gms/common/images/ImageManager;)Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->zzSa:Ljava/util/Map;
...
.method static synthetic zze(Lcom/google/android/gms/common/images/ImageManager;)Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->zzRZ:Ljava/util/Map;
...
.method static synthetic zzf(Lcom/google/android/gms/common/images/ImageManager;)Ljava/util/concurrent/ExecutorService;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->zzRV:Ljava/util/concurrent/ExecutorService;
...
.method private zzlw()V
    ...
    iget-object v2, p0, Lcom/google/android/gms/common/images/ImageManager;->zzRW:Lcom/google/android/gms/common/images/ImageManager$zzb;
...
.method static synthetic zzlx()Ljava/lang/Object;
    .locals 1

    sget-object v0, Lcom/google/android/gms/common/images/ImageManager;->zzRR:Ljava/lang/Object;

    return-object v0
.end method

.method static synthetic zzly()Ljava/util/HashSet;
    .locals 1

    sget-object v0, Lcom/google/android/gms/common/images/ImageManager;->zzRS:Ljava/util/HashSet;
...
.method public loadImage(Landroid/widget/ImageView;Landroid/net/Uri;I)V
    ...
    invoke-virtual {v0, p3}, Lcom/google/android/gms/common/images/zza;->zzaI(I)V
