...
# instance fields
.field private final zzUt:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap",
            "<",
...
.field private final zzUu:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap",
            "<",
...
.field private final zzUv:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/google/android/gms/common/server/converter/StringToIntConverter;->zzzH:I

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/server/converter/StringToIntConverter;->zzUt:Ljava/util/HashMap;
...
.method constructor <init>(ILjava/util/ArrayList;)V
    ...
    iput p1, p0, Lcom/google/android/gms/common/server/converter/StringToIntConverter;->zzzH:I
...
.method private zzb(Ljava/util/ArrayList;)V
    ...
    iget-object v2, v0, Lcom/google/android/gms/common/server/converter/StringToIntConverter$Entry;->zzUw:Ljava/lang/String;

    iget v0, v0, Lcom/google/android/gms/common/server/converter/StringToIntConverter$Entry;->zzUx:I

    invoke-virtual {p0, v2, v0}, Lcom/google/android/gms/common/server/converter/StringToIntConverter;->zzg(Ljava/lang/String;I)Lcom/google/android/gms/common/server/converter/StringToIntConverter;
...
.method getVersionCode()I
    ...
    iget v0, p0, Lcom/google/android/gms/common/server/converter/StringToIntConverter;->zzzH:I
...
.method public zzb(Ljava/lang/Integer;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/server/converter/StringToIntConverter;->zzUu:Ljava/util/HashMap;
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/server/converter/StringToIntConverter;->zzUt:Ljava/util/HashMap;
...
.method public zzg(Ljava/lang/String;I)Lcom/google/android/gms/common/server/converter/StringToIntConverter;
    .locals 2

    iget-object v0, p0, Lcom/google/android/gms/common/server/converter/StringToIntConverter;->zzUt:Ljava/util/HashMap;
...
.method zzmv()Ljava/util/ArrayList;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
