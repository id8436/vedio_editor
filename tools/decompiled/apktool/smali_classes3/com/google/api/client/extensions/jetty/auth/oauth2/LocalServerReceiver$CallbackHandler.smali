...
.method private writeLandingHtml(Ljavax/servlet/http/HttpServletResponse;)V
    ...
    .line 227
    const-string/jumbo v1, "<head><title>OAuth 2.0 Authentication Token Recieved</title></head>"
    ...
    .line 229
    const-string/jumbo v1, "Received verification code. Closing..."
    ...
    .line 233
    const-string/jumbo v1, "window.setTimeout(function() {"

    invoke-virtual {v0, v1}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    .line 234
    const-string/jumbo v1, "    window.open(\'\', \'_self\', \'\'); window.close(); }, 1000);"

    invoke-virtual {v0, v1}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    .line 235
    const-string/jumbo v1, "if (window.opener) { window.opener.checkToken(); }"
