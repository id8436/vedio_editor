...
.method private parse(Ljava/util/ArrayList;Ljava/lang/Object;Lcom/google/api/client/json/CustomizeJsonParser;)V
    ...
    const-string/jumbo v1, "final array/object fields are not supported"
...
.method private final parseValue(Ljava/lang/reflect/Field;Ljava/lang/reflect/Type;Ljava/util/ArrayList;Ljava/lang/Object;Lcom/google/api/client/json/CustomizeJsonParser;Z)Ljava/lang/Object;
    ...
    const-string/jumbo v5, "unexpected JSON node type: "
    ...
    :goto_9
    const-string/jumbo v4, "No value specified for @JsonPolymorphicTypeMap field"
    ...
    :goto_b
    const-string/jumbo v6, "No TypeDef annotation found with key: "
    ...
    const-string/jumbo v5, "expected numeric type but got "
    ...
    :goto_10
    const-string/jumbo v4, "number field formatted as a JSON string must use the @JsonString annotation"
