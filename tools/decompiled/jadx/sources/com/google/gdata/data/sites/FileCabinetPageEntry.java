...
public class FileCabinetPageEntry extends BasePageEntry<FileCabinetPageEntry> {
    public static final String KIND = "http://schemas.google.com/sites/2008#filecabinet";
    public static final Category CATEGORY = new Category("http://schemas.google.com/g/2005#kind", KIND, "filecabinet");

    public FileCabinetPageEntry() {
        getCategories().add(CATEGORY);
    }

    public FileCabinetPageEntry(BaseEntry<?> baseEntry) {
        super(baseEntry);
    }
    ...
    public void declareExtensions(ExtensionProfile extensionProfile) {
        if (!extensionProfile.isDeclared(FileCabinetPageEntry.class)) {
            super.declareExtensions(extensionProfile);
            extensionProfile.declare(FileCabinetPageEntry.class, new ExtensionDescription(FeedLink.class, new XmlNamespace("gd", "http://schemas.google.com/g/2005"), "feedLink", true, false, false));
