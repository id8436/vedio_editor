...
@ExtensionDescription.Default(localName = GphotoMaxPhotos.XML_NAME, nsAlias = Namespaces.PHOTOS_ALIAS, nsUri = Namespaces.PHOTOS)
public class GphotoMaxPhotos extends AbstractExtension {
    ...
    public static ExtensionDescription getDefaultDescription(boolean z, boolean z2) {
        ExtensionDescription defaultDescription = ExtensionDescription.getDefaultDescription(GphotoMaxPhotos.class);
    ...
    public boolean equals(Object obj) {
        ...
        return eq(this.value, ((GphotoMaxPhotos) obj).value);
    }
    ...
    public String toString() {
        return "{GphotoMaxPhotos value=" + this.value + "}";
    }
}
