...
@ExtensionDescription.Default(localName = GphotoPhotosUsed.XML_NAME, nsAlias = Namespaces.PHOTOS_ALIAS, nsUri = Namespaces.PHOTOS)
public class GphotoPhotosUsed extends AbstractExtension {
    ...
    public GphotoPhotosUsed(Integer num) {
        setValue(num);
        setImmutable(true);
    }
    ...
    public static ExtensionDescription getDefaultDescription(boolean z, boolean z2) {
        ExtensionDescription defaultDescription = ExtensionDescription.getDefaultDescription(GphotoPhotosUsed.class);
    ...
    public boolean equals(Object obj) {
        ...
        return eq(this.value, ((GphotoPhotosUsed) obj).value);
    }
    ...
    public String toString() {
        return "{GphotoPhotosUsed value=" + this.value + "}";
    }
}
