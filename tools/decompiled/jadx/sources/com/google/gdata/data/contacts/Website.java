...
@ExtensionDescription.Default(localName = "website", nsAlias = ContactsNamespace.GCONTACT_ALIAS, nsUri = ContactsNamespace.GCONTACT)
public class Website extends ExtensionPoint {
    private static final String HREF = "href";
    private static final String LABEL = "label";
    private static final String PRIMARY = "primary";
    private static final String REL = "rel";
    private static final AttributeHelper.EnumToAttributeValue<Rel> REL_ENUM_TO_ATTRIBUTE_VALUE = new AttributeHelper.EnumToAttributeValue<Rel>() { // from class: com.google.gdata.data.contacts.Website.1
    ...
    public Website(String str, String str2, Boolean bool, Rel rel) {
        setHref(str);
        setLabel(str2);
        setPrimary(bool);
        setRel(rel);
    ...
    public static ExtensionDescription getDefaultDescription(boolean z, boolean z2) {
        ExtensionDescription defaultDescription = ExtensionDescription.getDefaultDescription(Website.class);
    ...
    public boolean equals(Object obj) {
        ...
        return eq(this.href, website.href) && eq(this.label, website.label) && eq(this.primary, website.primary) && eq(this.rel, website.rel);
    }
    ...
    public String toString() {
        return "{Website href=" + this.href + " label=" + this.label + " primary=" + this.primary + " rel=" + this.rel + "}";
    }
}
