...
@ExtensionDescription.Default(localName = "description", nsAlias = DublincoreNamespace.DC_ALIAS, nsUri = DublincoreNamespace.DC)
public class Description extends ValueConstruct {
    ...
    public Description(String str) {
        super(DublincoreNamespace.DC_NS, "description", null, str);
    }
