...
@ExtensionDescription.Default(localName = "height", nsAlias = Namespaces.PHOTOS_ALIAS, nsUri = Namespaces.PHOTOS)
public class GphotoHeight extends AbstractExtension {
    ...
    public static ExtensionDescription getDefaultDescription(boolean z, boolean z2) {
        ExtensionDescription defaultDescription = ExtensionDescription.getDefaultDescription(GphotoHeight.class);
    ...
    public boolean equals(Object obj) {
        ...
        return eq(this.value, ((GphotoHeight) obj).value);
    }
    ...
    public String toString() {
        return "{GphotoHeight value=" + this.value + "}";
    }
}
