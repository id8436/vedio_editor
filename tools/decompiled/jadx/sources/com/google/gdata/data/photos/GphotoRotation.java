...
@ExtensionDescription.Default(localName = GphotoRotation.XML_NAME, nsAlias = Namespaces.PHOTOS_ALIAS, nsUri = Namespaces.PHOTOS)
public class GphotoRotation extends AbstractExtension {
    ...
    public static ExtensionDescription getDefaultDescription(boolean z, boolean z2) {
        ExtensionDescription defaultDescription = ExtensionDescription.getDefaultDescription(GphotoRotation.class);
    ...
    public boolean equals(Object obj) {
        ...
        return eq(this.value, ((GphotoRotation) obj).value);
    }
    ...
    public String toString() {
        return "{GphotoRotation value=" + this.value + "}";
    }
}
