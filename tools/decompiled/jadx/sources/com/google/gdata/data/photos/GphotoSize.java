...
@ExtensionDescription.Default(localName = "size", nsAlias = Namespaces.PHOTOS_ALIAS, nsUri = Namespaces.PHOTOS)
public class GphotoSize extends AbstractExtension {
    ...
    public static ExtensionDescription getDefaultDescription(boolean z, boolean z2) {
        ExtensionDescription defaultDescription = ExtensionDescription.getDefaultDescription(GphotoSize.class);
    ...
    public boolean equals(Object obj) {
        ...
        return eq(this.value, ((GphotoSize) obj).value);
    }
    ...
    public String toString() {
        return "{GphotoSize value=" + this.value + "}";
    }
}
