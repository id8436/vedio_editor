...
@ExtensionDescription.Default(localName = MergedInto.XML_NAME, nsAlias = ProjectHostingNamespace.ISSUES_ALIAS, nsUri = ProjectHostingNamespace.ISSUES)
public class MergedInto extends ExtensionPoint {
    static final String XML_NAME = "mergedInto";
