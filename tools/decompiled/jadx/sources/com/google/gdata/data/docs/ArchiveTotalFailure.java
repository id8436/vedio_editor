...
@ExtensionDescription.Default(localName = ArchiveTotalFailure.XML_NAME, nsAlias = DocsNamespace.DOCS_ALIAS, nsUri = "http://schemas.google.com/docs/2007")
public class ArchiveTotalFailure extends AbstractExtension {
    ...
    public ArchiveTotalFailure(Integer num) {
        setValue(num);
        setImmutable(true);
    }
    ...
    public static ExtensionDescription getDefaultDescription(boolean z, boolean z2) {
        ExtensionDescription defaultDescription = ExtensionDescription.getDefaultDescription(ArchiveTotalFailure.class);
    ...
    public boolean equals(Object obj) {
        ...
        return eq(this.value, ((ArchiveTotalFailure) obj).value);
    }
