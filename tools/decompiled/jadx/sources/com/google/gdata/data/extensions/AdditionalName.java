...
@ExtensionDescription.Default(localName = AdditionalName.XML_NAME, nsAlias = "gd", nsUri = "http://schemas.google.com/g/2005")
public class AdditionalName extends AbstractExtension {
    static final String XML_NAME = "additionalName";
    ...
    public AdditionalName(String str, String str2) {
        setValue(str);
        setYomi(str2);
        setImmutable(true);
    }
    ...
    public static ExtensionDescription getDefaultDescription(boolean z, boolean z2) {
        ExtensionDescription defaultDescription = ExtensionDescription.getDefaultDescription(AdditionalName.class);
    ...
    public boolean equals(Object obj) {
        ...
        return eq(this.value, additionalName.value) && eq(this.yomi, additionalName.yomi);
    }
    ...
    public String toString() {
        return "{AdditionalName value=" + this.value + " yomi=" + this.yomi + "}";
    }
}
