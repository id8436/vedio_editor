...
@ExtensionDescription.Default(localName = EntriesNumber.XML_NAME, nsAlias = SidewikiNamespace.SIDEWIKI_ALIAS, nsUri = SidewikiNamespace.SIDEWIKI)
public class EntriesNumber extends AbstractExtension {
    ...
    public EntriesNumber(Integer num) {
        setValue(num);
        setImmutable(true);
    }
    ...
    public static ExtensionDescription getDefaultDescription(boolean z, boolean z2) {
        ExtensionDescription defaultDescription = ExtensionDescription.getDefaultDescription(EntriesNumber.class);
    ...
    public boolean equals(Object obj) {
        ...
        return eq(this.value, ((EntriesNumber) obj).value);
    }
