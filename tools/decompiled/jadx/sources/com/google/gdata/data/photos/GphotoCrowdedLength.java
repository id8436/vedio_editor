...
@ExtensionDescription.Default(localName = GphotoCrowdedLength.XML_NAME, nsAlias = Namespaces.PHOTOS_ALIAS, nsUri = Namespaces.PHOTOS)
public class GphotoCrowdedLength extends AbstractExtension {
    ...
    public GphotoCrowdedLength(Integer num) {
        setValue(num);
        setImmutable(true);
    }
    ...
    public static ExtensionDescription getDefaultDescription(boolean z, boolean z2) {
        ExtensionDescription defaultDescription = ExtensionDescription.getDefaultDescription(GphotoCrowdedLength.class);
    ...
    public boolean equals(Object obj) {
        ...
        return eq(this.value, ((GphotoCrowdedLength) obj).value);
    }
    ...
    public String toString() {
        return "{GphotoCrowdedLength value=" + this.value + "}";
    }
}
