...
@ExtensionDescription.Default(localName = GphotoSubscribed.XML_NAME, nsAlias = Namespaces.PHOTOS_ALIAS, nsUri = Namespaces.PHOTOS)
public class GphotoSubscribed extends AbstractExtension {
    ...
    public boolean equals(Object obj) {
        ...
        return eq(this.value, ((GphotoSubscribed) obj).value);
    }
    ...
    public String toString() {
        return "{GphotoSubscribed value=" + this.value + "}";
    }
}
