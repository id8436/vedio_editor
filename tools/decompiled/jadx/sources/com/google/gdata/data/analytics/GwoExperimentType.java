...
@ExtensionDescription.Default(localName = GwoExperimentType.XML_NAME, nsAlias = AnalyticsNamespace.GWO_ALIAS, nsUri = AnalyticsNamespace.GWO)
public class GwoExperimentType extends AbstractExtension {
    private static final AttributeHelper.EnumToAttributeValue<Value> VALUE_ENUM_TO_ATTRIBUTE_VALUE = new AttributeHelper.EnumToAttributeValue<Value>() { // from class: com.google.gdata.data.analytics.GwoExperimentType.1
        @Override // com.google.gdata.data.AttributeHelper.EnumToAttributeValue
        public String getAttributeValue(Value value) {
            return value.toValue();
        }
    };
    static final String XML_NAME = "experimentType";
    ...
    public boolean equals(Object obj) {
        ...
        return eq(this.value, ((GwoExperimentType) obj).value);
    }
    ...
    public String toString() {
        return "{GwoExperimentType value=" + this.value + "}";
    }
}
