...
@ExtensionDescription.Default(localName = "position", nsAlias = Namespaces.PHOTOS_ALIAS, nsUri = Namespaces.PHOTOS)
public class GphotoPosition extends AbstractExtension {
    ...
    public static ExtensionDescription getDefaultDescription(boolean z, boolean z2) {
        ExtensionDescription defaultDescription = ExtensionDescription.getDefaultDescription(GphotoPosition.class);
    ...
    protected void consumeAttributes(AttributeHelper attributeHelper) throws ParseException {
        this.value = Float.valueOf(attributeHelper.consumeFloat(null, false));
    }
