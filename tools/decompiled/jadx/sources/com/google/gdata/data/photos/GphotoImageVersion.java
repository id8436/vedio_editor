...
@ExtensionDescription.Default(localName = GphotoImageVersion.XML_NAME, nsAlias = Namespaces.PHOTOS_ALIAS, nsUri = Namespaces.PHOTOS)
public class GphotoImageVersion extends AbstractExtension {
    ...
    public GphotoImageVersion(Long l) {
        setValue(l);
        setImmutable(true);
    }
    ...
    public static ExtensionDescription getDefaultDescription(boolean z, boolean z2) {
        ExtensionDescription defaultDescription = ExtensionDescription.getDefaultDescription(GphotoImageVersion.class);
    ...
    public boolean equals(Object obj) {
        ...
        return eq(this.value, ((GphotoImageVersion) obj).value);
    }
    ...
    public String toString() {
        return "{GphotoImageVersion value=" + this.value + "}";
    }
}
