...
@ExtensionDescription.Default(localName = "status", nsAlias = DocsNamespace.DOCS_ALIAS, nsUri = "http://schemas.google.com/docs/2007")
public class ExportStatus extends AbstractExtension {
    ...
    public static ExtensionDescription getDefaultDescription(boolean z, boolean z2) {
        ExtensionDescription defaultDescription = ExtensionDescription.getDefaultDescription(ExportStatus.class);
    ...
    public boolean equals(Object obj) {
        ...
        return eq(this.value, ((ExportStatus) obj).value);
    }
