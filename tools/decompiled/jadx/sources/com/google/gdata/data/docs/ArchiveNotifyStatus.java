...
@ExtensionDescription.Default(localName = ArchiveNotifyStatus.XML_NAME, nsAlias = DocsNamespace.DOCS_ALIAS, nsUri = "http://schemas.google.com/docs/2007")
public class ArchiveNotifyStatus extends AbstractExtension {
    ...
    public static ExtensionDescription getDefaultDescription(boolean z, boolean z2) {
        ExtensionDescription defaultDescription = ExtensionDescription.getDefaultDescription(ArchiveNotifyStatus.class);
    ...
    public boolean equals(Object obj) {
        ...
        return eq(this.value, ((ArchiveNotifyStatus) obj).value);
    }
    ...
    public String toString() {
        return "{ArchiveNotifyStatus value=" + this.value + "}";
    }
}
