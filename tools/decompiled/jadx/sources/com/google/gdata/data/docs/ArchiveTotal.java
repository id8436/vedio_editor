...
@ExtensionDescription.Default(localName = ArchiveTotal.XML_NAME, nsAlias = DocsNamespace.DOCS_ALIAS, nsUri = "http://schemas.google.com/docs/2007")
public class ArchiveTotal extends AbstractExtension {
    ...
    public ArchiveTotal(Integer num) {
        setValue(num);
        setImmutable(true);
    }
    ...
    public static ExtensionDescription getDefaultDescription(boolean z, boolean z2) {
        ExtensionDescription defaultDescription = ExtensionDescription.getDefaultDescription(ArchiveTotal.class);
    ...
    public boolean equals(Object obj) {
        ...
        return eq(this.value, ((ArchiveTotal) obj).value);
    }
