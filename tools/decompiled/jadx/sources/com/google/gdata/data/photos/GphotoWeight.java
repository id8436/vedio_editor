...
@ExtensionDescription.Default(localName = GphotoWeight.XML_NAME, nsAlias = Namespaces.PHOTOS_ALIAS, nsUri = Namespaces.PHOTOS)
public class GphotoWeight extends AbstractExtension {
    ...
    public static ExtensionDescription getDefaultDescription(boolean z, boolean z2) {
        ExtensionDescription defaultDescription = ExtensionDescription.getDefaultDescription(GphotoWeight.class);
    ...
    public boolean equals(Object obj) {
        ...
        return eq(this.value, ((GphotoWeight) obj).value);
    }
    ...
    public String toString() {
        return "{GphotoWeight value=" + this.value + "}";
    }
}
