...
@ExtensionDescription.Default(localName = "state", nsAlias = ProjectHostingNamespace.ISSUES_ALIAS, nsUri = ProjectHostingNamespace.ISSUES)
public class State extends AbstractExtension {
    ...
    static final String XML_NAME = "state";
    ...
    public static ExtensionDescription getDefaultDescription(boolean z, boolean z2) {
        ExtensionDescription defaultDescription = ExtensionDescription.getDefaultDescription(State.class);
    ...
    public boolean equals(Object obj) {
        ...
        return eq(this.value, ((State) obj).value);
    }
