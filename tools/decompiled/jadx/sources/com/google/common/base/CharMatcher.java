...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    public static CharMatcher is(final char c2) {
        return new FastMatcher("CharMatcher.is('" + showCharacter(c2) + "')") { // from class: com.google.common.base.CharMatcher.9
            @Override // com.google.common.base.CharMatcher
    ...
    public static CharMatcher isNot(final char c2) {
        return new FastMatcher("CharMatcher.isNot('" + showCharacter(c2) + "')") { // from class: com.google.common.base.CharMatcher.10
            @Override // com.google.common.base.CharMatcher
            public boolean matches(char c3) {
                return c3 != c2;
            }
    ...
    private static CharMatcher isEither(final char c2, final char c3) {
        return new FastMatcher("CharMatcher.anyOf(\"" + showCharacter(c2) + showCharacter(c3) + "\")") { // from class: com.google.common.base.CharMatcher.12
            @Override // com.google.common.base.CharMatcher
    ...
    public static CharMatcher forPredicate(final Predicate<? super Character> predicate) {
        ...
        return new CharMatcher("CharMatcher.forPredicate(" + predicate + ")") { // from class: com.google.common.base.CharMatcher.14
            @Override // com.google.common.base.CharMatcher
            public boolean matches(char c2) {
