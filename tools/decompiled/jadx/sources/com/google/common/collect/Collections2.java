...
public final class Collections2 {
    ...
    static String toStringImpl(final Collection<?> collection) {
        ...
        STANDARD_JOINER.appendTo(sbAppend, Iterables.transform(collection, new Function<Object, Object>() { // from class: com.google.common.collect.Collections2.1
    ...
    static StringBuilder newStringBuilderForCollection(int i) {
        CollectPreconditions.checkNonnegative(i, AdobeCommunityConstants.AdobeCommunityResourceSizeKey);
    ...
    final class OrderedPermutationCollection<E> extends AbstractCollection<List<E>> {
        ...
        private static <E> int calculateSize(List<E> list, Comparator<? super E> comparator) {
            ...
            return !Collections2.isPositiveInt(jBinomial2) ? ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED : (int) jBinomial2;
        }
    ...
    class PermutationIterator<E> extends AbstractIterator<List<E>> {
        ...
        void calculateNextPermutation() {
            ...
            while (true) {
                int i2 = this.f3175c[this.j] + this.o[this.j];
                if (i2 < 0) {
                    switchDirection();
                } else if (i2 == this.j + 1) {
                    if (this.j != 0) {
                    ...
                    Collections.swap(this.list, (this.j - this.f3175c[this.j]) + i, i + (this.j - i2));
                    this.f3175c[this.j] = i2;
                    return;
                }
            }
        }
