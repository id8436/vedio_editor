...
class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    class Row extends Maps.ImprovedAbstractMap<C, V> {
        ...
        public V put(C c2, V v) {
            Preconditions.checkNotNull(c2);
            Preconditions.checkNotNull(v);
            return (this.backingRowMap == null || this.backingRowMap.isEmpty()) ? (V) StandardTable.this.put(this.rowKey, c2, v) : this.backingRowMap.put(c2, v);
        }
        ...
        class EntrySet extends Sets.ImprovedAbstractSet<Map.Entry<R, V>> {
            ...
            public int size() {
                ...
                while (true) {
                    int i2 = i;
                    if (it.hasNext()) {
                        i = it.next().containsKey(Column.this.columnKey) ? i2 + 1 : i2;
                    } else {
                        return i2;
                    }
                }
