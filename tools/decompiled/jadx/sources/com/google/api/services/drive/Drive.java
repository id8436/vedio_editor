...
public class Drive extends AbstractGoogleJsonClient {
    ...
    static {
        Preconditions.checkState(GoogleUtils.MAJOR_VERSION.intValue() == 1 && GoogleUtils.MINOR_VERSION.intValue() >= 15, "You are currently running with version %s of google-api-client. You need at least version 1.15 of google-api-client to run version 1.23.0 of the Drive API library.", GoogleUtils.VERSION);
    }
    ...
    public class Files {
        ...
        public class Get extends DriveRequest<File> {
            ...
            public GenericUrl buildHttpRequestUrl() {
                return new GenericUrl(UriTemplate.expand(("media".equals(get(GDataProtocol.Parameter.ALT)) && getMediaHttpUploader() == null) ? Drive.this.getRootUrl() + "download/" + Drive.this.getServicePath() : Drive.this.getBaseUrl(), getUriTemplate(), this, true));
            }
    ...
    public final class Builder extends AbstractGoogleJsonClient.Builder {
        public Builder(HttpTransport httpTransport, JsonFactory jsonFactory, HttpRequestInitializer httpRequestInitializer) {
            super(httpTransport, jsonFactory, "https://www.googleapis.com/", Drive.DEFAULT_SERVICE_PATH, httpRequestInitializer, false);
