    ...
    public LowLevelHttpRequest buildRequest(String str, String str2) throws IOException {
        return str2.equals(this.tokenServerUrl) ? new MockLowLevelHttpRequest(str2) { // from class: com.google.api.client.googleapis.testing.auth.oauth2.MockTokenServerTransport.1
            ...
            public LowLevelHttpResponse execute() throws IOException {
                ...
                String str4 = query.get(BehanceSDKUrlUtil.PARAM_KEY_CLIENT_ID);
                if (str4 != null) {
                    ...
                    String str7 = query.get(AdobeAuthIdentityManagementService.IMS_KEY_REFRESH_TOKEN);
                    ...
                    String str8 = (String) jsonWebSignature.getPayload().get(GoogleOAuthParameters.SCOPE_KEY);
