...
public abstract class AbstractGoogleJsonClient extends AbstractGoogleClient {
    ...
    public abstract class Builder extends AbstractGoogleClient.Builder {
        ...
        protected Builder(HttpTransport httpTransport, JsonFactory jsonFactory, String str, String str2, HttpRequestInitializer httpRequestInitializer, boolean z) {
            super(httpTransport, str, str2, new JsonObjectParser.Builder(jsonFactory).setWrapperKeys(z ? Arrays.asList("data", Adobe360Constants.kAdobe360SatusError) : Collections.emptySet()).build(), httpRequestInitializer);
        }
