...
public final class ParsableBitArray {
    ...
    public long readBitsLong(int i) {
        ...
        if (i != 0) {
            while (i >= 8) {
                i -= 8;
                unsignedByte |= (long) (readUnsignedByte() << i);
            }
            if (i > 0) {
                int i2 = this.bitOffset + i;
                byte b2 = (byte) (255 >> (8 - i));
                if (i2 > 8) {
                    unsignedByte |= (long) (b2 & ((getUnsignedByte(this.byteOffset) << (i2 - 8)) | (getUnsignedByte(this.byteOffset + 1) >> (16 - i2))));
                    this.byteOffset++;
                } else {
                    unsignedByte |= (long) (b2 & (getUnsignedByte(this.byteOffset) >> (8 - i2)));
                    if (i2 == 8) {
                        this.byteOffset++;
                    }
                }
