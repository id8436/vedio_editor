...
public final class C$Gson$Types {
    ...
    private static Type resolve(Type type, Class<?> cls, Type type2, Collection<TypeVariable> collection) {
        ...
        if (typeResolveTypeVariable instanceof ParameterizedType) {
            ...
            for (int i = 0; i < length; i++) {
                Type typeResolve5 = resolve(type, cls, typeArr[i], collection);
        ...
        if (typeResolveTypeVariable instanceof WildcardType) {
            ...
            if (upperBounds.length == 1 && (typeResolve = resolve(type, cls, upperBounds[0], collection)) != upperBounds[0]) {
    ...
    final class ParameterizedTypeImpl implements Serializable, ParameterizedType {
        ...
        public String toString() {
            ...
            sb.append(C$Gson$Types.typeToString(this.rawType)).append(Engagement.Comparison.LT).append(C$Gson$Types.typeToString(this.typeArguments[0]));
