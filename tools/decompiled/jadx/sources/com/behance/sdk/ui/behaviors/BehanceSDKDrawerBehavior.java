...
public class BehanceSDKDrawerBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public BehanceSDKDrawerBehavior() {
        ...
        this.mDragCallback = new ViewDragHelper.Callback() { // from class: com.behance.sdk.ui.behaviors.BehanceSDKDrawerBehavior.2
            ...
            public boolean tryCaptureView(View view, int i) {
                View view2;
                if (BehanceSDKDrawerBehavior.this.mState == 1 || BehanceSDKDrawerBehavior.this.mTouchingScrollingChild) {
                    return false;
                }
                if (BehanceSDKDrawerBehavior.this.mState == 3 && BehanceSDKDrawerBehavior.this.mActivePointerId == i && (view2 = (View) BehanceSDKDrawerBehavior.this.mNestedScrollingChildRef.get()) != null && ViewCompat.canScrollVertically(view2, -1)) {
                    return false;
                }
                return BehanceSDKDrawerBehavior.this.mViewRef != null && BehanceSDKDrawerBehavior.this.mViewRef.get() == view;
            }
            ...
            public void onViewReleased(View view, float f2, float f3) {
                ...
                int i2 = 3;
                if (f3 < 0.0f) {
                    if (view.getTop() < BehanceSDKDrawerBehavior.this.mMaxOffset) {
                        i = BehanceSDKDrawerBehavior.this.mMinOffset;
                    } else {
                        i = BehanceSDKDrawerBehavior.this.mMaxOffset;
                        i2 = 4;
                    }
                } else if (BehanceSDKDrawerBehavior.this.shouldHide(view, f3)) {
                    i = BehanceSDKDrawerBehavior.this.mParentHeight;
                    i2 = 5;
                } else if (f3 != 0.0f) {
                    i = BehanceSDKDrawerBehavior.this.mMaxOffset;
                    i2 = 4;
                    ...
                    int top = view.getTop();
                    if (Math.abs(top - BehanceSDKDrawerBehavior.this.mMinOffset) < Math.abs(top - BehanceSDKDrawerBehavior.this.mMaxOffset)) {
                        i = BehanceSDKDrawerBehavior.this.mMinOffset;
                    } else {
                        i = BehanceSDKDrawerBehavior.this.mMaxOffset;
                        i2 = 4;
                ...
                if (BehanceSDKDrawerBehavior.this.mViewDragHelper.settleCapturedViewAt(view.getLeft(), i)) {
                    BehanceSDKDrawerBehavior.this.setStateInternal(2);
                    ViewCompat.postOnAnimation(view, new SettleRunnable(view, i2));
                } else {
                    BehanceSDKDrawerBehavior.this.setStateInternal(i2);
                }
            }

            @Override // android.support.v4.widget.ViewDragHelper.Callback
            public int clampViewPositionVertical(View view, int i, int i2) {
                return constrain(i, BehanceSDKDrawerBehavior.this.mMinOffset, BehanceSDKDrawerBehavior.this.mParentHeight);
            }
            ...
            public int getViewVerticalDragRange(View view) {
                return BehanceSDKDrawerBehavior.this.mParentHeight - BehanceSDKDrawerBehavior.this.mMinOffset;
            }
        };
    }
    ...
    public BehanceSDKDrawerBehavior(Context context, AttributeSet attributeSet) {
        ...
        this.drawerMinHeight = BehanceSDKUIUtils.getActionBarSize(context);
        setPeekHeight(Math.min((context.getResources().getDisplayMetrics().heightPixels / 2) - this.drawerMinHeight, (context.getResources().getDisplayMetrics().widthPixels * 9) / 16));
    ...
    public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, V v, int i) {
        ...
        this.mParentHeight = coordinatorLayout.getHeight() - this.drawerMinHeight;
        ...
        if (view == this.mNestedScrollingChildRef.get()) {
            ...
            if (i2 > 0) {
                if (v.getTop() != this.mMaxOffset && v.getTop() > 0) {
                    iArr[1] = i2;
                    ViewCompat.offsetTopAndBottom(v, v.getTop() >= i2 ? -i2 : -v.getTop());
                    setStateInternal(1);
                }
            } else if (i2 < 0 && !ViewCompat.canScrollVertically(view, -1) && top <= this.mParentHeight) {
                iArr[1] = i2;
    ...
    */
    public final void setPeekHeight(int r4) {
        ...
        Lb:
            ...
            r1 = 4
            if (r0 != r1) goto L23
            java.lang.ref.WeakReference<V extends android.view.View> r0 = r3.mViewRef
            if (r0 == 0) goto L23
            java.lang.ref.WeakReference<V extends android.view.View> r0 = r3.mViewRef
        ...
        L3a:
            ...
            goto Lb
        */
        throw new UnsupportedOperationException("Method not decompiled: com.behance.sdk.ui.behaviors.BehanceSDKDrawerBehavior.setPeekHeight(int):void");
    }
    ...
    boolean shouldHide(View view, float f2) {
        ...
        return view.getTop() >= this.mMaxOffset && Math.abs((((float) view.getTop()) + (HIDE_FRICTION * f2)) - ((float) this.mMaxOffset)) / ((float) this.mPeekHeight) > HIDE_THRESHOLD;
    }

    private View findScrollingChild(View view) {
        if (!(view instanceof NestedScrollingChild) || (this.scrollingChildId >= 0 && this.scrollingChildId != view.getId())) {
    ...
    class SettleRunnable implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            if (BehanceSDKDrawerBehavior.this.mViewDragHelper != null && BehanceSDKDrawerBehavior.this.mViewDragHelper.continueSettling(true)) {
    ...
    public class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new ParcelableCompatCreatorCallbacks<SavedState>() { // from class: com.behance.sdk.ui.behaviors.BehanceSDKDrawerBehavior.SavedState.1
    ...
    public static <V extends View> BehanceSDKDrawerBehavior<V> from(V v) {
        ...
        return (BehanceSDKDrawerBehavior) behavior;
    }
}
