...
public class BehanceSDKProjectEditorStyleItemViewHolder extends RecyclerView.ViewHolder {
    public RelativeLayout bsdkCardProjectEditorStyleContainer;
    public BehanceSDKTextView bsdkCardProjectEditorStyleTextLeft;
    public BehanceSDKTextView bsdkCardProjectEditorStyleTextRight;

    public BehanceSDKProjectEditorStyleItemViewHolder(View view) {
        super(view);
        ...
        this.bsdkCardProjectEditorStyleTextRight = (BehanceSDKTextView) view.findViewById(R.id.bsdk_card_project_editor_style_text_right);
    }
}
