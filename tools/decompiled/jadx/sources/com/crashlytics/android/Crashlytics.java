...
public class Crashlytics extends q<Void> implements r {
    public static final String TAG = "Crashlytics";
    public final Answers answers;
    public final Beta beta;
    public final CrashlyticsCore core;
    public final Collection<? extends q> kits;
    ...
    public void setDebugMode(boolean z) {
        f.h().d(TAG, "Use of Crashlytics.setDebugMode is deprecated.");
    }

    @Deprecated
    public boolean getDebugMode() {
        f.h().d(TAG, "Use of Crashlytics.getDebugMode is deprecated.");
        getFabric();
        return f.i();
    }
    ...
    public static void setPinningInfoProvider(PinningInfoProvider pinningInfoProvider) {
        f.h().d(TAG, "Use of Crashlytics.setPinningInfoProvider is deprecated");
    }
