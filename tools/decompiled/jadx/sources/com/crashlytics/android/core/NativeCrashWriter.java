...
class NativeCrashWriter {
    ...
    final class RepeatedMessage extends ProtobufMessage {
        ...
        public int getSize() {
            int size = 0;
            for (ProtobufMessage protobufMessage : this.messages) {
                size += protobufMessage.getSize();
            }
            return size;
        }
    }

    final class NullMessage extends ProtobufMessage {
        public NullMessage() {
            super(0, new ProtobufMessage[0]);
        }
    ...
    final class LogMessage extends ProtobufMessage {
    ...
    final class BinaryImageMessage extends ProtobufMessage {
        ...
        @Override // com.crashlytics.android.core.NativeCrashWriter.ProtobufMessage
        public int getPropertiesSize() {
            int iComputeUInt64Size = CodedOutputStream.computeUInt64Size(1, this.baseAddr);
            return iComputeUInt64Size + CodedOutputStream.computeBytesSize(3, ByteString.copyFromUtf8(this.filePath)) + CodedOutputStream.computeUInt64Size(2, this.imageSize) + CodedOutputStream.computeBytesSize(4, ByteString.copyFromUtf8(this.uuid));
        }
    ...
    private static EventMessage createEventMessage(SessionEventData sessionEventData, LogFileManager logFileManager, Map<String, String> map) throws IOException {
        ...
        DeviceMessage deviceMessageCreateDeviceMessage = createDeviceMessage(sessionEventData.deviceData);
        ...
        return new EventMessage(sessionEventData.timestamp, NDK_CRASH_TYPE, applicationMessage, deviceMessageCreateDeviceMessage, byteStringForLog != null ? new LogMessage(byteStringForLog) : new NullMessage());
    }
