...
public class GPUMediaKuwaharaFilter extends GPUMediaFilter {
    ...
    public GPUMediaKuwaharaFilter() {
        this(3);
    }

    public GPUMediaKuwaharaFilter(int i) {
        super(GPUMediaFilter.NO_FILTER_VERTEX_SHADER, KUWAHARA_FRAGMENT_SHADER);
        this.mRadius = i;
    }
