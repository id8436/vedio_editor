...
public class GPUMediaSketchFilter extends GPUMediaFilterGroup {
    ...
    public GPUMediaSketchFilter() {
        addFilter(new GPUMediaGrayscaleFilter());
        addFilter(new GPUMedia3x3TextureSamplingFilter(SKETCH_FRAGMENT_SHADER));
    }
}
