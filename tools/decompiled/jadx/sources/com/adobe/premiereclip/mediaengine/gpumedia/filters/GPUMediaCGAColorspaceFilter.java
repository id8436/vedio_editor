...
public class GPUMediaCGAColorspaceFilter extends GPUMediaFilter {
    ...
    public GPUMediaCGAColorspaceFilter() {
        super(GPUMediaFilter.NO_FILTER_VERTEX_SHADER, CGACOLORSPACE_FRAGMENT_SHADER);
    }
}
