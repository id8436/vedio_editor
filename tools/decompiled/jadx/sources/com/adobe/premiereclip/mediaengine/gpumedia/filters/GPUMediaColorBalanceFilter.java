...
public class GPUMediaColorBalanceFilter extends GPUMediaFilter {
    ...
    public GPUMediaColorBalanceFilter() {
        super(GPUMediaFilter.NO_FILTER_VERTEX_SHADER, GPU_IMAGE_COLOR_BALANCE_FRAGMENT_SHADER);
    ...
    public void setShowdows(float[] fArr) {
        this.showdows = fArr;
        setFloatVec3(this.mShadowsLocation, fArr);
    }

    public void setMidtones(float[] fArr) {
        this.midtones = fArr;
        setFloatVec3(this.mMidtonesLocation, fArr);
    }

    public void setHighlights(float[] fArr) {
        this.highlights = fArr;
        setFloatVec3(this.mHighlightsLocation, fArr);
    }

    public void setPreserveLuminosity(boolean z) {
        this.preserveLuminosity = z;
        setInteger(this.mPreserveLuminosityLocation, z ? 1 : 0);
    }
}
