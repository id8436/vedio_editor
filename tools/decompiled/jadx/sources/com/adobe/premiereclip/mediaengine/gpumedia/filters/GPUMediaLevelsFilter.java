...
public class GPUMediaLevelsFilter extends GPUMediaFilter {
    ...
    private static final String LOGTAG = GPUMediaLevelsFilter.class.getSimpleName();
    private float[] mMax;
    ...
    public GPUMediaLevelsFilter() {
        this(new float[]{0.0f, 0.0f, 0.0f}, new float[]{1.0f, 1.0f, 1.0f}, new float[]{1.0f, 1.0f, 1.0f}, new float[]{0.0f, 0.0f, 0.0f}, new float[]{1.0f, 1.0f, 1.0f});
    }

    private GPUMediaLevelsFilter(float[] fArr, float[] fArr2, float[] fArr3, float[] fArr4, float[] fArr5) {
        super(GPUMediaFilter.NO_FILTER_VERTEX_SHADER, LEVELS_FRAGMET_SHADER);
        this.mMin = fArr;
        this.mMid = fArr2;
        this.mMax = fArr3;
