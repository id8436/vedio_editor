...
public class GPUMediaHueFilter extends GPUMediaFilter {
    ...
    public GPUMediaHueFilter() {
        this(90.0f);
    }

    public GPUMediaHueFilter(float f2) {
        super(GPUMediaFilter.NO_FILTER_VERTEX_SHADER, HUE_FRAGMENT_SHADER);
        this.mHue = f2;
    }
