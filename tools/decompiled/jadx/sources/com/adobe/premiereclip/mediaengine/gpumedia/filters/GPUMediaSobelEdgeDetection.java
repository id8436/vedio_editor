...
public class GPUMediaSobelEdgeDetection extends GPUMediaFilterGroup {
    ...
    public GPUMediaSobelEdgeDetection() {
        addFilter(new GPUMediaGrayscaleFilter());
        addFilter(new GPUMedia3x3TextureSamplingFilter(SOBEL_EDGE_DETECTION));
    }
