...
public class GPUMediaToonFilter extends GPUMedia3x3TextureSamplingFilter {
    ...
    public GPUMediaToonFilter() {
        this(0.2f, 10.0f);
    }

    public GPUMediaToonFilter(float f2, float f3) {
        super(TOON_FRAGMENT_SHADER);
        this.mThreshold = f2;
        this.mQuantizationLevels = f3;
    }

    @Override // com.adobe.premiereclip.mediaengine.gpumedia.filters.GPUMedia3x3TextureSamplingFilter, com.adobe.premiereclip.mediaengine.gpumedia.filters.GPUMediaFilter
    ...
    public void setThreshold(float f2) {
        this.mThreshold = f2;
        setFloat(this.mThresholdLocation, f2);
    }

    public void setQuantizationLevels(float f2) {
        this.mQuantizationLevels = f2;
        setFloat(this.mQuantizationLevelsLocation, f2);
    }
}
