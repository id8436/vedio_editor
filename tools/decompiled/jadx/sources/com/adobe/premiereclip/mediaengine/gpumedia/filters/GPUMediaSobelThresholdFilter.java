...
public class GPUMediaSobelThresholdFilter extends GPUMedia3x3TextureSamplingFilter {
    ...
    public GPUMediaSobelThresholdFilter() {
        this(0.9f);
    }

    public GPUMediaSobelThresholdFilter(float f2) {
    ...
    public void setThreshold(float f2) {
        this.mThreshold = f2;
        setFloat(this.mUniformThresholdLocation, f2);
    }
}
