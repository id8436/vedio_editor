...
public class GPUMediaWhiteBalanceFilter extends GPUMediaFilter {
    ...
    public GPUMediaWhiteBalanceFilter() {
        this(5000.0f, 0.0f);
    }

    public GPUMediaWhiteBalanceFilter(float f2, float f3) {
        super(GPUMediaFilter.NO_FILTER_VERTEX_SHADER, WHITE_BALANCE_FRAGMENT_SHADER);
