...
public class GPUMediaHighlightShadowFilter extends GPUMediaFilter {
    ...
    public GPUMediaHighlightShadowFilter() {
        this(0.0f, 1.0f);
    }

    public GPUMediaHighlightShadowFilter(float f2, float f3) {
        super(GPUMediaFilter.NO_FILTER_VERTEX_SHADER, HIGHLIGHT_SHADOW_FRAGMENT_SHADER);
        this.mHighlights = f3;
        this.mShadows = f2;
    }
