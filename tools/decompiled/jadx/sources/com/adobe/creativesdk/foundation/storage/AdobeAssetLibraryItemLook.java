...
@Deprecated
public class AdobeAssetLibraryItemLook extends AdobeAssetLibraryItem {
    ...
    protected AdobeAssetLibraryItemLook(AdobeDCXManifestNode adobeDCXManifestNode, String str, AdobeAssetFile adobeAssetFile, int i, int i2, AdobeAssetLibrary adobeAssetLibrary) {
