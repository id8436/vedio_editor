...
public class AdobeAssetCompFile extends AdobeAssetPackagePages {
    static final /* synthetic */ boolean $assertionsDisabled;

    static {
        $assertionsDisabled = !AdobeAssetCompFile.class.desiredAssertionStatus();
    }
    ...
    public void loadMetadata(final IAdobeRequestCompletionCallback iAdobeRequestCompletionCallback, IAdobeGenericErrorCallback<AdobeCSDKException> iAdobeGenericErrorCallback) {
        super.loadMetadata(new IAdobeRequestCompletionCallback() { // from class: com.adobe.creativesdk.foundation.storage.AdobeAssetCompFile.1
            ...
            public void onCompletion() {
                ...
                if (allChildren != null) {
                    ...
                    Collections.sort(arrayList2, new Comparator<String>() { // from class: com.adobe.creativesdk.foundation.storage.AdobeAssetCompFile.1.1
    ...
    public boolean equals(Object obj) {
        if (obj instanceof AdobeAssetCompFile) {
            return super.equals(obj);
        }
        return false;
    }

    protected AdobeAssetCompFile(AdobeStorageResourceCollection adobeStorageResourceCollection, AdobeStorageResourceCollection adobeStorageResourceCollection2) {
        super(adobeStorageResourceCollection, adobeStorageResourceCollection2);
    }

    protected AdobeAssetCompFile() {
    }
