...
public class AdobeAnalyticsETSPhotoEvent extends AdobeAnalyticsETSAssetsBaseEvent {
    public AdobeAnalyticsETSPhotoEvent(String str) {
        super(str);
        ...
        this.data.put(AdobeAnalyticsEventParams.Content.AdobeEventPropertyContentType.getValue(), "photo");
    }
}
