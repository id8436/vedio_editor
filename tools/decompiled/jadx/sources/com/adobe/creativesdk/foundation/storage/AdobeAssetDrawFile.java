...
public class AdobeAssetDrawFile extends AdobeAssetPackagePages {
    ...
    static {
        $assertionsDisabled = !AdobeAssetDrawFile.class.desiredAssertionStatus();
    }
        ...
        super.loadMetadata(new IAdobeRequestCompletionCallback() { // from class: com.adobe.creativesdk.foundation.storage.AdobeAssetDrawFile.1
            ...
            public void onCompletion() {
                ...
                if (allChildren != null) {
                    ...
                    Collections.sort(arrayList2, new Comparator<String>() { // from class: com.adobe.creativesdk.foundation.storage.AdobeAssetDrawFile.1.1
    ...
    protected AdobeAssetDrawFile(AdobeStorageResourceCollection adobeStorageResourceCollection, AdobeStorageResourceCollection adobeStorageResourceCollection2) {
        super(adobeStorageResourceCollection, adobeStorageResourceCollection2);
    }

    protected AdobeAssetDrawFile() {
    }
