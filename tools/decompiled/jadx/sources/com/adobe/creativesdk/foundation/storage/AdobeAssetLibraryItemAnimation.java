...
@Deprecated
public class AdobeAssetLibraryItemAnimation extends AdobeAssetLibraryItem {
    ...
    protected AdobeAssetLibraryItemAnimation(AdobeDCXManifestNode adobeDCXManifestNode, String str, AdobeAssetFile adobeAssetFile, int i, int i2, AdobeAssetLibrary adobeAssetLibrary) {
