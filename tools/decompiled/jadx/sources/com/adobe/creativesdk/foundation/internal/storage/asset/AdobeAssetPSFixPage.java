...
public class AdobeAssetPSFixPage extends AdobeAssetFile {
    static final /* synthetic */ boolean $assertionsDisabled;
    public AdobeAssetPackagePages _package;
    public int pageNumber;

    static {
        $assertionsDisabled = !AdobeAssetPSFixPage.class.desiredAssertionStatus();
    }

    public AdobeAssetPSFixPage(String str, int i, AdobeDCXComponent adobeDCXComponent, AdobeAssetPackagePages adobeAssetPackagePages) {
        this.name = str;
        this.pageNumber = i;
    ...
    public boolean equals(Object obj) {
        if (obj instanceof AdobeAssetPSFixPage) {
