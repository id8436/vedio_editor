...
public class AdobeAssetDrawPage extends AdobeAssetFile {
    static final /* synthetic */ boolean $assertionsDisabled;
    public AdobeAssetPackagePages _package;
    public int pageNumber;

    static {
        $assertionsDisabled = !AdobeAssetDrawPage.class.desiredAssertionStatus();
    }

    public AdobeAssetDrawPage(String str, int i, AdobeDCXComponent adobeDCXComponent, AdobeAssetPackagePages adobeAssetPackagePages) {
        this.name = str;
        this.pageNumber = i;
    ...
    public boolean equals(Object obj) {
        if (obj instanceof AdobeAssetDrawPage) {
