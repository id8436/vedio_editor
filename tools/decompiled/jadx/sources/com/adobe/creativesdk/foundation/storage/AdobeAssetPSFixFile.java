...
public class AdobeAssetPSFixFile extends AdobeAssetPackagePages {
    static final /* synthetic */ boolean $assertionsDisabled;

    static {
        $assertionsDisabled = !AdobeAssetPSFixFile.class.desiredAssertionStatus();
    }
    ...
    public void loadMetadata(final IAdobeRequestCompletionCallback iAdobeRequestCompletionCallback, IAdobeGenericErrorCallback<AdobeCSDKException> iAdobeGenericErrorCallback) {
        super.loadMetadata(new IAdobeRequestCompletionCallback() { // from class: com.adobe.creativesdk.foundation.storage.AdobeAssetPSFixFile.1
            ...
            public void onCompletion() {
                ...
                if (allChildren != null) {
                    ...
                    Collections.sort(arrayList2, new Comparator<String>() { // from class: com.adobe.creativesdk.foundation.storage.AdobeAssetPSFixFile.1.1
                    ...
                    while (it.hasNext()) {
                        ...
                        if (next != null) {
                            AdobeAssetPSFixPage adobeAssetPSFixPage = new AdobeAssetPSFixPage(adobeDCXManifestNode.getName(), ((int) adobeDCXManifestNode.getAbsoluteIndex()) + 1, next, this);
    ...
    public boolean equals(Object obj) {
        if (obj instanceof AdobeAssetPSFixFile) {
            return super.equals(obj);
        }
        return false;
    }

    protected AdobeAssetPSFixFile(AdobeStorageResourceCollection adobeStorageResourceCollection, AdobeStorageResourceCollection adobeStorageResourceCollection2) {
        super(adobeStorageResourceCollection, adobeStorageResourceCollection2);
    }

    protected AdobeAssetPSFixFile() {
    }
