...
public class MediaFormat {
    ...
    public static MediaFormat createVideoFormat(String str, int i, int i2, int i3, List<byte[]> list) {
        return createVideoFormat(str, i, -1L, i2, i3, 0, list);
    }

    public static MediaFormat createVideoFormat(String str, int i, long j, int i2, int i3, int i4, List<byte[]> list) {
        return createVideoFormat(str, i, j, i2, i3, i4, 1.0f, list);
    }

    public static MediaFormat createVideoFormat(String str, int i, long j, int i2, int i3, int i4, float f2, List<byte[]> list) {
        return new MediaFormat(str, i, j, i2, i3, i4, f2, -1, -1, list);
    }
    ...
    public static MediaFormat createAudioFormat(String str, int i, long j, int i2, int i3, List<byte[]> list) {
        return new MediaFormat(str, i, j, -1, -1, -1, -1.0f, i2, i3, list);
    }
    ...
    public static MediaFormat createFormatForMimeType(String str) {
        return new MediaFormat(str, -1, -1L, -1, -1, -1, -1.0f, -1, -1, null);
    }
    ...
    private MediaFormat(String str, int i, long j, int i2, int i3, int i4, float f2, int i5, int i6, List<byte[]> list) {
        this.mimeType = str;
        this.maxInputSize = i;
        this.durationUs = j;
        this.width = i2;
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            int iHashCode = (((((((((((((((((((this.mimeType == null ? 0 : this.mimeType.hashCode()) + 527) * 31) + this.maxInputSize) * 31) + this.width) * 31) + this.height) * 31) + Float.floatToRawIntBits(this.pixelWidthHeightRatio)) * 31) + ((int) this.durationUs)) * 31) + this.maxWidth) * 31) + this.maxHeight) * 31) + this.channelCount) * 31) + this.sampleRate;
    ...
    private boolean equalsInternal(MediaFormat mediaFormat, boolean z) {
        ...
        if ((!z && (this.maxWidth != mediaFormat.maxWidth || this.maxHeight != mediaFormat.maxHeight)) || this.channelCount != mediaFormat.channelCount || this.sampleRate != mediaFormat.sampleRate || !Utilities.areEqual(this.mimeType, mediaFormat.mimeType) || this.initializationData.size() != mediaFormat.initializationData.size()) {
            return false;
        }
        for (int i = 0; i < this.initializationData.size(); i++) {
