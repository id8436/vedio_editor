...
public final class CryptoInfo {
    ...
    public CryptoInfo() {
        this.frameworkCryptoInfo = Utilities.SDK_INT >= 16 ? newFrameworkCryptoInfoV16() : null;
    }
    ...
    @TargetApi(16)
    public void setFromExtractorV16(ClipExtractor clipExtractor) {
        clipExtractor.getSampleCryptoInfo(this.frameworkCryptoInfo);
