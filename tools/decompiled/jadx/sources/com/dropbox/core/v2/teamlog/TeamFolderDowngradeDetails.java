...
public class TeamFolderDowngradeDetails {
    ...
    class Serializer extends StructSerializer<TeamFolderDowngradeDetails> {
        ...
        public void serialize(TeamFolderDowngradeDetails teamFolderDowngradeDetails, g gVar, boolean z) throws IOException {
            if (!z) {
                gVar.e();
            }
            gVar.a("target_asset_index");
            StoneSerializers.uInt64().serialize(Long.valueOf(teamFolderDowngradeDetails.targetAssetIndex), gVar);
            if (!z) {
                gVar.f();
            }
        }
        ...
        @Override // com.dropbox.core.stone.StructSerializer
        public TeamFolderDowngradeDetails deserialize(k kVar, boolean z) throws IOException {
            String tag;
            ...
            if (tag == null) {
                ...
                TeamFolderDowngradeDetails teamFolderDowngradeDetails = new TeamFolderDowngradeDetails(lDeserialize.longValue());
                if (!z) {
