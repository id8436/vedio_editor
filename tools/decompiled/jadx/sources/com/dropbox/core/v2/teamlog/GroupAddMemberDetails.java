...
public class GroupAddMemberDetails {
    ...
    class Serializer extends StructSerializer<GroupAddMemberDetails> {
        ...
        public void serialize(GroupAddMemberDetails groupAddMemberDetails, g gVar, boolean z) throws IOException {
            if (!z) {
                gVar.e();
            }
            gVar.a("is_group_owner");
            StoneSerializers.boolean_().serialize(Boolean.valueOf(groupAddMemberDetails.isGroupOwner), gVar);
            if (!z) {
                gVar.f();
            }
        }
        ...
        @Override // com.dropbox.core.stone.StructSerializer
        public GroupAddMemberDetails deserialize(k kVar, boolean z) throws IOException {
            String tag;
            ...
            if (tag == null) {
                ...
                GroupAddMemberDetails groupAddMemberDetails = new GroupAddMemberDetails(boolDeserialize.booleanValue());
                if (!z) {
