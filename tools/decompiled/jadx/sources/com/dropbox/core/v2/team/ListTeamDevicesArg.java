...
class ListTeamDevicesArg {
    ...
    class Serializer extends StructSerializer<ListTeamDevicesArg> {
        ...
        public void serialize(ListTeamDevicesArg listTeamDevicesArg, g gVar, boolean z) throws IOException {
            if (!z) {
                gVar.e();
            }
            if (listTeamDevicesArg.cursor != null) {
                gVar.a("cursor");
                StoneSerializers.nullable(StoneSerializers.string()).serialize(listTeamDevicesArg.cursor, gVar);
            }
            gVar.a("include_web_sessions");
            StoneSerializers.boolean_().serialize(Boolean.valueOf(listTeamDevicesArg.includeWebSessions), gVar);
            gVar.a("include_desktop_clients");
            StoneSerializers.boolean_().serialize(Boolean.valueOf(listTeamDevicesArg.includeDesktopClients), gVar);
            gVar.a("include_mobile_clients");
            StoneSerializers.boolean_().serialize(Boolean.valueOf(listTeamDevicesArg.includeMobileClients), gVar);
            if (!z) {
                gVar.f();
            }
        }
        ...
        @Override // com.dropbox.core.stone.StructSerializer
        public ListTeamDevicesArg deserialize(k kVar, boolean z) throws IOException {
            String tag;
