...
public final class LookupError {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && (obj instanceof LookupError)) {
            ...
            switch (this._tag) {
                case MALFORMED_PATH:
                    return this.malformedPathValue == lookupError.malformedPathValue || this.malformedPathValue.equals(lookupError.malformedPathValue);
                case NOT_FOUND:
                case NOT_FILE:
                case NOT_FOLDER:
    ...
    class Serializer extends UnionSerializer<LookupError> {
        ...
        public void serialize(LookupError lookupError, g gVar) throws IOException {
            switch (lookupError.tag()) {
                case MALFORMED_PATH:
                    ...
                    StoneSerializers.string().serialize(lookupError.malformedPathValue, gVar);
                    gVar.f();
                    break;
                case NOT_FOUND:
                    gVar.b("not_found");
        ...
        public LookupError deserialize(k kVar) throws IOException {
            ...
            if ("malformed_path".equals(tag)) {
                ...
                lookupErrorMalformedPath = LookupError.malformedPath(StoneSerializers.string().deserialize(kVar));
