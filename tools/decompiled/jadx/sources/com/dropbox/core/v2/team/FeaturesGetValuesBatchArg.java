...
class FeaturesGetValuesBatchArg {
    ...
    class Serializer extends StructSerializer<FeaturesGetValuesBatchArg> {
        ...
        public void serialize(FeaturesGetValuesBatchArg featuresGetValuesBatchArg, g gVar, boolean z) throws IOException {
            if (!z) {
                gVar.e();
            }
            gVar.a("features");
            StoneSerializers.list(Feature.Serializer.INSTANCE).serialize(featuresGetValuesBatchArg.features, gVar);
            if (!z) {
                gVar.f();
            }
        }
        ...
        @Override // com.dropbox.core.stone.StructSerializer
        public FeaturesGetValuesBatchArg deserialize(k kVar, boolean z) throws IOException {
            String tag;
            List list = null;
            if (z) {
                tag = null;
