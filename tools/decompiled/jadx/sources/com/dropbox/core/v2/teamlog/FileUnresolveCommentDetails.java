...
public class FileUnresolveCommentDetails {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && obj.getClass().equals(getClass())) {
            ...
            if (this.targetAssetIndex == fileUnresolveCommentDetails.targetAssetIndex) {
                ...
                if (this.commentText != null && this.commentText.equals(fileUnresolveCommentDetails.commentText)) {
                    return true;
                }
            }
            return false;
    ...
    class Serializer extends StructSerializer<FileUnresolveCommentDetails> {
        ...
        public void serialize(FileUnresolveCommentDetails fileUnresolveCommentDetails, g gVar, boolean z) throws IOException {
            if (!z) {
                gVar.e();
            }
            gVar.a("target_asset_index");
            StoneSerializers.uInt64().serialize(Long.valueOf(fileUnresolveCommentDetails.targetAssetIndex), gVar);
            if (fileUnresolveCommentDetails.commentText != null) {
                gVar.a("comment_text");
                StoneSerializers.nullable(StoneSerializers.string()).serialize(fileUnresolveCommentDetails.commentText, gVar);
            }
            if (!z) {
                gVar.f();
            }
        ...
        @Override // com.dropbox.core.stone.StructSerializer
        public FileUnresolveCommentDetails deserialize(k kVar, boolean z) throws IOException {
            String tag;
            String str;
            Long lDeserialize;
            String str2 = null;
            ...
            if (tag == null) {
                ...
                FileUnresolveCommentDetails fileUnresolveCommentDetails = new FileUnresolveCommentDetails(l.longValue(), str2);
                if (!z) {
