...
public enum GroupsMembersListContinueError {
    ...
    class Serializer extends UnionSerializer<GroupsMembersListContinueError> {
        ...
        public void serialize(GroupsMembersListContinueError groupsMembersListContinueError, g gVar) throws IOException {
        ...
        @Override // com.dropbox.core.stone.StoneSerializer
        public GroupsMembersListContinueError deserialize(k kVar) throws IOException {
            boolean z;
            String tag;
