...
public class FileRevertDetails {
    ...
    class Serializer extends StructSerializer<FileRevertDetails> {
        ...
        public void serialize(FileRevertDetails fileRevertDetails, g gVar, boolean z) throws IOException {
            if (!z) {
                gVar.e();
            }
            if (!z) {
        ...
        @Override // com.dropbox.core.stone.StructSerializer
        public FileRevertDetails deserialize(k kVar, boolean z) throws IOException {
            String tag = null;
            if (!z) {
