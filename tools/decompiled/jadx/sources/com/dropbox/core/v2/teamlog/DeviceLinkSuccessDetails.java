...
public class DeviceLinkSuccessDetails {
    ...
    public DeviceLinkSuccessDetails(DeviceLogInfo deviceLogInfo) {
    ...
    public boolean equals(Object obj) {
        ...
        return this.deviceInfo == deviceLinkSuccessDetails.deviceInfo || this.deviceInfo.equals(deviceLinkSuccessDetails.deviceInfo);
    }
    ...
    class Serializer extends StructSerializer<DeviceLinkSuccessDetails> {
        ...
        public void serialize(DeviceLinkSuccessDetails deviceLinkSuccessDetails, g gVar, boolean z) throws IOException {
            if (!z) {
                gVar.e();
            }
            gVar.a("device_info");
            DeviceLogInfo.Serializer.INSTANCE.serialize(deviceLinkSuccessDetails.deviceInfo, gVar);
            if (!z) {
                gVar.f();
            }
        }
        ...
        @Override // com.dropbox.core.stone.StructSerializer
        public DeviceLinkSuccessDetails deserialize(k kVar, boolean z) throws IOException {
            String tag;
            ...
            if (tag == null) {
                ...
                DeviceLinkSuccessDetails deviceLinkSuccessDetails = new DeviceLinkSuccessDetails(deviceLogInfoDeserialize);
                if (!z) {
