...
public class UserLinkedAppLogInfo extends AppLogInfo {
    ...
    class Serializer extends StructSerializer<UserLinkedAppLogInfo> {
        ...
        public void serialize(UserLinkedAppLogInfo userLinkedAppLogInfo, g gVar, boolean z) throws IOException {
            if (!z) {
                gVar.e();
            }
            writeTag("user_linked_app", gVar);
            if (userLinkedAppLogInfo.appId != null) {
                gVar.a("app_id");
                StoneSerializers.nullable(StoneSerializers.string()).serialize(userLinkedAppLogInfo.appId, gVar);
            }
            if (userLinkedAppLogInfo.displayName != null) {
                gVar.a("display_name");
                StoneSerializers.nullable(StoneSerializers.string()).serialize(userLinkedAppLogInfo.displayName, gVar);
            }
            if (!z) {
                gVar.f();
            }
        ...
        @Override // com.dropbox.core.stone.StructSerializer
        public UserLinkedAppLogInfo deserialize(k kVar, boolean z) throws IOException {
            String tag;
            String str;
            String str2;
            String str3 = null;
            ...
            if (tag == null) {
                ...
                UserLinkedAppLogInfo userLinkedAppLogInfo = new UserLinkedAppLogInfo(str4, str3);
                if (!z) {
