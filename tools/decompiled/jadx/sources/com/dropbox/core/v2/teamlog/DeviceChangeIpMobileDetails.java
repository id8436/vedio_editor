...
public class DeviceChangeIpMobileDetails {
    ...
    public DeviceChangeIpMobileDetails(DeviceLogInfo deviceLogInfo) {
    ...
    public boolean equals(Object obj) {
        ...
        return this.deviceInfo == deviceChangeIpMobileDetails.deviceInfo || this.deviceInfo.equals(deviceChangeIpMobileDetails.deviceInfo);
    }
    ...
    class Serializer extends StructSerializer<DeviceChangeIpMobileDetails> {
        ...
        public void serialize(DeviceChangeIpMobileDetails deviceChangeIpMobileDetails, g gVar, boolean z) throws IOException {
            if (!z) {
                gVar.e();
            }
            gVar.a("device_info");
            DeviceLogInfo.Serializer.INSTANCE.serialize(deviceChangeIpMobileDetails.deviceInfo, gVar);
            if (!z) {
                gVar.f();
            }
        }
        ...
        @Override // com.dropbox.core.stone.StructSerializer
        public DeviceChangeIpMobileDetails deserialize(k kVar, boolean z) throws IOException {
            String tag;
            ...
            if (tag == null) {
                ...
                DeviceChangeIpMobileDetails deviceChangeIpMobileDetails = new DeviceChangeIpMobileDetails(deviceLogInfoDeserialize);
                if (!z) {
