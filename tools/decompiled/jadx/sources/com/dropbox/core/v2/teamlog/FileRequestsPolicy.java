...
public enum FileRequestsPolicy {
    ...
    class Serializer extends UnionSerializer<FileRequestsPolicy> {
        ...
        public void serialize(FileRequestsPolicy fileRequestsPolicy, g gVar) throws IOException {
        ...
        @Override // com.dropbox.core.stone.StoneSerializer
        public FileRequestsPolicy deserialize(k kVar) throws IOException {
            boolean z;
            String tag;
