...
public class SsoRemoveLogoutUrlDetails {
    ...
    class Serializer extends StructSerializer<SsoRemoveLogoutUrlDetails> {
        ...
        public void serialize(SsoRemoveLogoutUrlDetails ssoRemoveLogoutUrlDetails, g gVar, boolean z) throws IOException {
            if (!z) {
                gVar.e();
            }
            gVar.a("previous_value");
            StoneSerializers.string().serialize(ssoRemoveLogoutUrlDetails.previousValue, gVar);
            if (!z) {
                gVar.f();
            }
        }
        ...
        @Override // com.dropbox.core.stone.StructSerializer
        public SsoRemoveLogoutUrlDetails deserialize(k kVar, boolean z) throws IOException {
            String tag;
            ...
            if (tag == null) {
                ...
                SsoRemoveLogoutUrlDetails ssoRemoveLogoutUrlDetails = new SsoRemoveLogoutUrlDetails(strDeserialize);
                if (!z) {
