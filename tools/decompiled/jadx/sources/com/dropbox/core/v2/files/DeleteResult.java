...
public class DeleteResult extends FileOpsResult {
    ...
    class Serializer extends StructSerializer<DeleteResult> {
        ...
        public void serialize(DeleteResult deleteResult, g gVar, boolean z) throws IOException {
            if (!z) {
                gVar.e();
            }
            gVar.a("metadata");
            Metadata.Serializer.INSTANCE.serialize(deleteResult.metadata, gVar);
            if (!z) {
                gVar.f();
            }
        }
        ...
        @Override // com.dropbox.core.stone.StructSerializer
        public DeleteResult deserialize(k kVar, boolean z) throws IOException {
            String tag;
            ...
            if (tag == null) {
                ...
                DeleteResult deleteResult = new DeleteResult(metadataDeserialize);
                if (!z) {
