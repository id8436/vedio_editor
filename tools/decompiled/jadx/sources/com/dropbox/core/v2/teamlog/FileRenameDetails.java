...
public class FileRenameDetails {
    ...
    public boolean equals(Object obj) {
        ...
        return this.relocateActionDetails == fileRenameDetails.relocateActionDetails || this.relocateActionDetails.equals(fileRenameDetails.relocateActionDetails);
    }
    ...
    class Serializer extends StructSerializer<FileRenameDetails> {
        ...
        public void serialize(FileRenameDetails fileRenameDetails, g gVar, boolean z) throws IOException {
            if (!z) {
                gVar.e();
            }
            gVar.a("relocate_action_details");
            StoneSerializers.list(RelocateAssetReferencesLogInfo.Serializer.INSTANCE).serialize(fileRenameDetails.relocateActionDetails, gVar);
            if (!z) {
                gVar.f();
            }
        }
        ...
        @Override // com.dropbox.core.stone.StructSerializer
        public FileRenameDetails deserialize(k kVar, boolean z) throws IOException {
            String tag;
            List list = null;
            if (z) {
                tag = null;
