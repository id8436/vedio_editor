...
public class SharedFileMembers {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && obj.getClass().equals(getClass())) {
            ...
            if ((this.users == sharedFileMembers.users || this.users.equals(sharedFileMembers.users)) && ((this.groups == sharedFileMembers.groups || this.groups.equals(sharedFileMembers.groups)) && (this.invitees == sharedFileMembers.invitees || this.invitees.equals(sharedFileMembers.invitees)))) {
                if (this.cursor == sharedFileMembers.cursor) {
                    return true;
                }
                if (this.cursor != null && this.cursor.equals(sharedFileMembers.cursor)) {
                    return true;
                }
            }
            return false;
    ...
    class Serializer extends StructSerializer<SharedFileMembers> {
        ...
        public void serialize(SharedFileMembers sharedFileMembers, g gVar, boolean z) throws IOException {
            if (!z) {
                gVar.e();
            }
            gVar.a("users");
            StoneSerializers.list(UserFileMembershipInfo.Serializer.INSTANCE).serialize(sharedFileMembers.users, gVar);
            gVar.a("groups");
            StoneSerializers.list(GroupMembershipInfo.Serializer.INSTANCE).serialize(sharedFileMembers.groups, gVar);
            gVar.a("invitees");
            StoneSerializers.list(InviteeMembershipInfo.Serializer.INSTANCE).serialize(sharedFileMembers.invitees, gVar);
            if (sharedFileMembers.cursor != null) {
                gVar.a("cursor");
                StoneSerializers.nullable(StoneSerializers.string()).serialize(sharedFileMembers.cursor, gVar);
            }
            if (!z) {
                gVar.f();
            }
        ...
        @Override // com.dropbox.core.stone.StructSerializer
        public SharedFileMembers deserialize(k kVar, boolean z) throws IOException {
            String tag;
            String str;
            List list;
            List list2;
            ...
            if (tag == null) {
                ...
                while (kVar.c() == o.FIELD_NAME) {
                    ...
                    if ("users".equals(strD)) {
                        ...
                        list = list4;
                        list2 = list5;
                        list3 = (List) StoneSerializers.list(UserFileMembershipInfo.Serializer.INSTANCE).deserialize(kVar);
                        str = str3;
                ...
                SharedFileMembers sharedFileMembers = new SharedFileMembers(list6, list5, list4, str2);
                if (!z) {
