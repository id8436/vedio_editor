...
public class SmartSyncOptOutDetails {
    ...
    class Serializer extends StructSerializer<SmartSyncOptOutDetails> {
        ...
        public void serialize(SmartSyncOptOutDetails smartSyncOptOutDetails, g gVar, boolean z) throws IOException {
            if (!z) {
                gVar.e();
            }
        ...
        @Override // com.dropbox.core.stone.StructSerializer
        public SmartSyncOptOutDetails deserialize(k kVar, boolean z) throws IOException {
            String tag;
            ...
            if (tag == null) {
                ...
                SmartSyncOptOutDetails smartSyncOptOutDetails = new SmartSyncOptOutDetails(smartSyncOptOutPolicyDeserialize2, smartSyncOptOutPolicyDeserialize);
                if (!z) {
