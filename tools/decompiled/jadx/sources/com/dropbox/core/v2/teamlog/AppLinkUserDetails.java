...
public class AppLinkUserDetails {
    ...
    public boolean equals(Object obj) {
        ...
        return this.appInfo == appLinkUserDetails.appInfo || this.appInfo.equals(appLinkUserDetails.appInfo);
    }
    ...
    class Serializer extends StructSerializer<AppLinkUserDetails> {
        ...
        public void serialize(AppLinkUserDetails appLinkUserDetails, g gVar, boolean z) throws IOException {
            if (!z) {
                gVar.e();
            }
            gVar.a("app_info");
            AppLogInfo.Serializer.INSTANCE.serialize(appLinkUserDetails.appInfo, gVar);
            if (!z) {
                gVar.f();
            }
        }
        ...
        @Override // com.dropbox.core.stone.StructSerializer
        public AppLinkUserDetails deserialize(k kVar, boolean z) throws IOException {
            String tag;
            ...
            if (tag == null) {
                ...
                AppLinkUserDetails appLinkUserDetails = new AppLinkUserDetails(appLogInfoDeserialize);
                if (!z) {
