...
public class ListTeamDevicesResult {
    ...
    class Serializer extends StructSerializer<ListTeamDevicesResult> {
        ...
        public void serialize(ListTeamDevicesResult listTeamDevicesResult, g gVar, boolean z) throws IOException {
            if (!z) {
                gVar.e();
            }
            gVar.a("devices");
            StoneSerializers.list(MemberDevices.Serializer.INSTANCE).serialize(listTeamDevicesResult.devices, gVar);
            gVar.a("has_more");
            StoneSerializers.boolean_().serialize(Boolean.valueOf(listTeamDevicesResult.hasMore), gVar);
            if (listTeamDevicesResult.cursor != null) {
                gVar.a("cursor");
                StoneSerializers.nullable(StoneSerializers.string()).serialize(listTeamDevicesResult.cursor, gVar);
            }
            if (!z) {
                gVar.f();
            }
        ...
        @Override // com.dropbox.core.stone.StructSerializer
        public ListTeamDevicesResult deserialize(k kVar, boolean z) throws IOException {
            String tag;
            String str;
            ...
            if (tag == null) {
                ...
                ListTeamDevicesResult listTeamDevicesResult = new ListTeamDevicesResult(list2, bool.booleanValue(), str2);
                if (!z) {
