...
public final class GetTemporaryLinkError {
    ...
    class Serializer extends UnionSerializer<GetTemporaryLinkError> {
        ...
        public void serialize(GetTemporaryLinkError getTemporaryLinkError, g gVar) throws IOException {
            switch (getTemporaryLinkError.tag()) {
                case PATH:
                    gVar.e();
                    writeTag("path", gVar);
                    gVar.a("path");
                    LookupError.Serializer.INSTANCE.serialize(getTemporaryLinkError.pathValue, gVar);
                    gVar.f();
                    break;
                default:
                    gVar.b("other");
        ...
        @Override // com.dropbox.core.stone.StoneSerializer
        public GetTemporaryLinkError deserialize(k kVar) throws IOException {
            boolean z;
            String tag;
            GetTemporaryLinkError getTemporaryLinkErrorPath;
            ...
            if ("path".equals(tag)) {
                ...
                getTemporaryLinkErrorPath = GetTemporaryLinkError.path(LookupError.Serializer.INSTANCE.deserialize(kVar));
            } else {
                getTemporaryLinkErrorPath = GetTemporaryLinkError.OTHER;
            }
            if (!z) {
                skipFields(kVar);
                expectEndObject(kVar);
            }
            return getTemporaryLinkErrorPath;
        }
    }
}
