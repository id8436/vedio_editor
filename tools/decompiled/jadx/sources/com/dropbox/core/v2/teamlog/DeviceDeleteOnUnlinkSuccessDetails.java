...
public class DeviceDeleteOnUnlinkSuccessDetails {
    ...
    public boolean equals(Object obj) {
        ...
        return this.deviceInfo == deviceDeleteOnUnlinkSuccessDetails.deviceInfo || this.deviceInfo.equals(deviceDeleteOnUnlinkSuccessDetails.deviceInfo);
    }
    ...
    class Serializer extends StructSerializer<DeviceDeleteOnUnlinkSuccessDetails> {
        ...
        public void serialize(DeviceDeleteOnUnlinkSuccessDetails deviceDeleteOnUnlinkSuccessDetails, g gVar, boolean z) throws IOException {
            if (!z) {
                gVar.e();
            }
            gVar.a("device_info");
            DeviceLogInfo.Serializer.INSTANCE.serialize(deviceDeleteOnUnlinkSuccessDetails.deviceInfo, gVar);
            if (!z) {
                gVar.f();
            }
        }
        ...
        @Override // com.dropbox.core.stone.StructSerializer
        public DeviceDeleteOnUnlinkSuccessDetails deserialize(k kVar, boolean z) throws IOException {
            String tag;
            ...
            if (tag == null) {
                ...
                DeviceDeleteOnUnlinkSuccessDetails deviceDeleteOnUnlinkSuccessDetails = new DeviceDeleteOnUnlinkSuccessDetails(deviceLogInfoDeserialize);
                if (!z) {
