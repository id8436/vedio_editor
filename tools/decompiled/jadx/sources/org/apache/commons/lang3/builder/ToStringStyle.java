...
public abstract class ToStringStyle implements Serializable {
    ...
    private String fieldNameValueSeparator = Engagement.Comparison.EQ;
    private boolean fieldSeparatorAtStart = false;
    private boolean fieldSeparatorAtEnd = false;
    private String fieldSeparator = BehanceSDKConstants.TAG_CLIENT_SIDE_SEPERATOR;
    private String arrayStart = "{";
    private String arraySeparator = BehanceSDKConstants.TAG_CLIENT_SIDE_SEPERATOR;
    private boolean arrayContentDetail = true;
    private String arrayEnd = "}";
    private boolean defaultFullDetail = true;
    private String nullText = "<null>";
    private String sizeStartText = "<size=";
    private String sizeEndText = Engagement.Comparison.GT;
    private String summaryObjectStartText = Engagement.Comparison.LT;
    private String summaryObjectEndText = Engagement.Comparison.GT;
