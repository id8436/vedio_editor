...
public class FormattableUtils {
    ...
    public static Formatter append(CharSequence charSequence, Formatter formatter, int i, int i2, int i3, char c2) {
        return append(charSequence, formatter, i, i2, i3, c2, null);
    }
    ...
    public static Formatter append(CharSequence charSequence, Formatter formatter, int i, int i2, int i3, char c2, CharSequence charSequence2) {
