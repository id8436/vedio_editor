...
public class EndianUtils {
    ...
    public static short readSwappedShort(byte[] bArr, int i) {
        return (short) (((bArr[i + 0] & UnsignedBytes.MAX_VALUE) << 0) + ((bArr[i + 1] & UnsignedBytes.MAX_VALUE) << 8));
    }

    public static int readSwappedUnsignedShort(byte[] bArr, int i) {
        return ((bArr[i + 0] & UnsignedBytes.MAX_VALUE) << 0) + ((bArr[i + 1] & UnsignedBytes.MAX_VALUE) << 8);
    }
    ...
    public static long readSwappedUnsignedInteger(byte[] bArr, int i) {
        return (((long) (((bArr[i + 0] & UnsignedBytes.MAX_VALUE) << 0) + ((bArr[i + 1] & UnsignedBytes.MAX_VALUE) << 8) + ((bArr[i + 2] & UnsignedBytes.MAX_VALUE) << 16))) & 4294967295L) + (((long) (bArr[i + 3] & UnsignedBytes.MAX_VALUE)) << 24);
    }
    ...
    public static long readSwappedLong(byte[] bArr, int i) {
        return (((long) (((bArr[i + 0] & UnsignedBytes.MAX_VALUE) << 0) + ((bArr[i + 1] & UnsignedBytes.MAX_VALUE) << 8) + ((bArr[i + 2] & UnsignedBytes.MAX_VALUE) << 16) + ((bArr[i + 3] & UnsignedBytes.MAX_VALUE) << 24))) & 4294967295L) + (((long) (((((bArr[i + 4] & UnsignedBytes.MAX_VALUE) << 0) + ((bArr[i + 5] & UnsignedBytes.MAX_VALUE) << 8)) + ((bArr[i + 6] & UnsignedBytes.MAX_VALUE) << 16)) + ((bArr[i + 7] & UnsignedBytes.MAX_VALUE) << 24))) << 32);
    }
