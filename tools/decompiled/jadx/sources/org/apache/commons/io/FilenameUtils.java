...
public class FilenameUtils {
    ...
    private static String doNormalize(String str, char c2, boolean z) {
        ...
        if (length != 0) {
            ...
            while (i5 < i3) {
                if (cArr[i5] == c2 && cArr[i5 - 1] == '.' && (i5 == prefixLength + 1 || cArr[i5 - 2] == c2)) {
                    if (i5 == i3 - 1) {
                        z2 = true;
                    }
            ...
            while (i6 < i3) {
                if (cArr[i6] == c2 && cArr[i6 - 1] == '.' && cArr[i6 - 2] == '.' && (i6 == prefixLength + 2 || cArr[i6 - 3] == c2)) {
    ...
    public static int getPrefixLength(String str) {
        ...
        if (length == 1) {
            ...
            return !isSeparator(cCharAt) ? 0 : 1;
        }
        if (cCharAt == '~') {
        ...
        return Math.min(iIndexOf3, iIndexOf4) + 1;
    }
    ...
    private static String doGetPath(String str, int i) {
        ...
        int i2 = iIndexOfLastSeparator + i;
    ...
    private static String doGetFullPath(String str, boolean z) {
        ...
        if (str != null && (prefixLength = getPrefixLength(str)) >= 0) {
            ...
            int i = (z ? 1 : 0) + iIndexOfLastSeparator;
            if (i == 0) {
                i++;
            }
    ...
    public static String removeExtension(String str) {
        ...
        int iIndexOfExtension = indexOfExtension(str);
        return iIndexOfExtension != -1 ? str.substring(0, iIndexOfExtension) : str;
    }
