...
public class ByteArrayOutputStream extends OutputStream {
    ...
    public void write(byte[] bArr, int i, int i2) {
        ...
        if (i2 != 0) {
            synchronized (this) {
                ...
                int i5 = i2;
                while (i5 > 0) {
                    int iMin = Math.min(i5, this.currentBuffer.length - i4);
                    System.arraycopy(bArr, (i + i2) - i5, this.currentBuffer, i4, iMin);
                    i5 -= iMin;
                    if (i5 > 0) {
                        needNewBuffer(i3);
                        i4 = 0;
    ...
    public synchronized int write(InputStream inputStream) throws IOException {
        ...
        while (i3 != -1) {
            i += i3;
            i4 += i3;
            this.count = i3 + this.count;
            if (i4 == this.currentBuffer.length) {
                needNewBuffer(this.currentBuffer.length);
                i4 = 0;
            }
            i3 = inputStream.read(this.currentBuffer, i4, this.currentBuffer.length - i4);
        }
        return i;
    }
    ...
    public synchronized void writeTo(OutputStream outputStream) throws IOException {
        ...
        do {
            ...
            byte[] next = it.next();
            int iMin = Math.min(next.length, i2);
            outputStream.write(next, 0, iMin);
            i = i2 - iMin;
        } while (i != 0);
    }
    ...
    private InputStream toBufferedInputStream() {
        ...
        do {
            ...
            byte[] next = it.next();
            int iMin = Math.min(next.length, i2);
            arrayList.add(new ByteArrayInputStream(next, 0, iMin));
            i = i2 - iMin;
        } while (i != 0);
        ...
        synchronized (this) {
            ...
            if (i2 == 0) {
                ...
                do {
                    ...
                    byte[] next = it.next();
                    int iMin = Math.min(next.length, i3);
                    System.arraycopy(next, 0, bArr2, i4, iMin);
                    i = i4 + iMin;
                    i2 = i3 - iMin;
                } while (i2 != 0);
                bArr = bArr2;
