    ...
    public final class Property extends AbstractReadableInstantFieldProperty {
        ...
        public DateTime withMaximumValue() {
            try {
                ...
                if (IllegalInstantException.isIllegalInstant(e2)) {
                    return new DateTime(getChronology().getZone().previousTransition(getMillis() + DateUtils.MILLIS_PER_DAY), getChronology());
                }
                throw e2;
            }
        }
        ...
        public DateTime withMinimumValue() {
            try {
                ...
                if (IllegalInstantException.isIllegalInstant(e2)) {
                    return new DateTime(getChronology().getZone().nextTransition(getMillis() - DateUtils.MILLIS_PER_DAY), getChronology());
                }
                throw e2;
            }
        }
