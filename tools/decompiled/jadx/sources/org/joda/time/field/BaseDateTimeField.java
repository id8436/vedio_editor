...
public abstract class BaseDateTimeField extends DateTimeField {
    ...
    */
    public int[] add(org.joda.time.ReadablePartial r9, int r10, int[] r11, int r12) {
        ...
        L31:
            ...
            java.lang.String r1 = "Maximum value exceeded for add"
            r0.<init>(r1)
            throw r0
        L3e:
            int r0 = r10 + (-1)
    ...
    /* JADX WARN: Code restructure failed: missing block: B:26:0x009e, code lost:
        ...
        if (getRangeDurationField().getType() == r0.getDurationField().getType()) goto L29;
     */
    ...
    */
    ...
    public long roundHalfEven(long j) {
        ...
        return (j3 >= j2 && (get(jRoundCeiling) & 1) != 0) ? jRoundFloor : jRoundCeiling;
    }
