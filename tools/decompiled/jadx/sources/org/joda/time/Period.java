...
public final class Period extends BasePeriod implements Serializable, ReadablePeriod {
    ...
    public Weeks toStandardWeeks() {
        ...
        return Weeks.weeks(FieldUtils.safeToInt((((((((long) getMillis()) + (((long) getSeconds()) * 1000)) + (((long) getMinutes()) * DateUtils.MILLIS_PER_MINUTE)) + (((long) getHours()) * DateUtils.MILLIS_PER_HOUR)) + (((long) getDays()) * DateUtils.MILLIS_PER_DAY)) / 604800000) + ((long) getWeeks())));
    }

    public Days toStandardDays() {
        checkYearsAndMonths("Days");
        return Days.days(FieldUtils.safeToInt(FieldUtils.safeAdd(FieldUtils.safeAdd((((((long) getMillis()) + (((long) getSeconds()) * 1000)) + (((long) getMinutes()) * DateUtils.MILLIS_PER_MINUTE)) + (((long) getHours()) * DateUtils.MILLIS_PER_HOUR)) / DateUtils.MILLIS_PER_DAY, getDays()), ((long) getWeeks()) * 7)));
    }

    public Hours toStandardHours() {
        checkYearsAndMonths("Hours");
        return Hours.hours(FieldUtils.safeToInt(FieldUtils.safeAdd(FieldUtils.safeAdd(FieldUtils.safeAdd(((((long) getMillis()) + (((long) getSeconds()) * 1000)) + (((long) getMinutes()) * DateUtils.MILLIS_PER_MINUTE)) / DateUtils.MILLIS_PER_HOUR, getHours()), ((long) getDays()) * 24), ((long) getWeeks()) * 168)));
    }

    public Minutes toStandardMinutes() {
        checkYearsAndMonths("Minutes");
        return Minutes.minutes(FieldUtils.safeToInt(FieldUtils.safeAdd(FieldUtils.safeAdd(FieldUtils.safeAdd(FieldUtils.safeAdd((((long) getMillis()) + (((long) getSeconds()) * 1000)) / DateUtils.MILLIS_PER_MINUTE, getMinutes()), ((long) getHours()) * 60), ((long) getDays()) * 1440), ((long) getWeeks()) * 10080)));
    }
    ...
    public Duration toStandardDuration() {
        ...
        return new Duration(((long) getMillis()) + (((long) getSeconds()) * 1000) + (((long) getMinutes()) * DateUtils.MILLIS_PER_MINUTE) + (((long) getHours()) * DateUtils.MILLIS_PER_HOUR) + (((long) getDays()) * DateUtils.MILLIS_PER_DAY) + (((long) getWeeks()) * 604800000));
    }
    ...
    public Period normalizedStandard(PeriodType periodType) {
        PeriodType periodType2 = DateTimeUtils.getPeriodType(periodType);
        Period period = new Period(((long) getMillis()) + (((long) getSeconds()) * 1000) + (((long) getMinutes()) * DateUtils.MILLIS_PER_MINUTE) + (((long) getHours()) * DateUtils.MILLIS_PER_HOUR) + (((long) getDays()) * DateUtils.MILLIS_PER_DAY) + (((long) getWeeks()) * 604800000), periodType2, ISOChronology.getInstanceUTC());
        int years = getYears();
