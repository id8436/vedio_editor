...
public final class JulianChronology extends BasicGJChronology {
    ...
    public static JulianChronology getInstance(DateTimeZone dateTimeZone, int i) {
        ...
        if (julianChronologyArr2 == null) {
            ...
            JulianChronology[] julianChronologyArrPutIfAbsent = cCache.putIfAbsent(dateTimeZone, julianChronologyArr);
    ...
    long calculateFirstDayOfYearMillis(int i) {
        ...
        return ((((long) i2) + (((long) i3) * 365)) * DateUtils.MILLIS_PER_DAY) - 62035200000L;
    }
