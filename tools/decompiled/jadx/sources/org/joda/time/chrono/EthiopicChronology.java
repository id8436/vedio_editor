...
public final class EthiopicChronology extends BasicFixedMonthChronology {
    ...
    public static EthiopicChronology getInstance(DateTimeZone dateTimeZone, int i) {
        ...
        if (ethiopicChronologyArr2 == null) {
            ...
            EthiopicChronology[] ethiopicChronologyArrPutIfAbsent = cCache.putIfAbsent(dateTimeZone, ethiopicChronologyArr3);
            ethiopicChronologyArr = ethiopicChronologyArrPutIfAbsent != null ? ethiopicChronologyArrPutIfAbsent : ethiopicChronologyArr3;
        } else {
    ...
    long calculateFirstDayOfYearMillis(int i) {
        ...
        return ((((long) i2) + (((long) i3) * 365)) * DateUtils.MILLIS_PER_DAY) + 21859200000L;
    }
