...
public final class GJChronology extends AssembledChronology {
    ...
    public static GJChronology getInstance(DateTimeZone dateTimeZone, ReadableInstant readableInstant, int i) {
        ...
        if (gJChronology2 == null) {
            ...
            GJChronology gJChronologyPutIfAbsent = cCache.putIfAbsent(gJCacheKey, gJChronology);
    ...
    class CutoverField extends BaseDateTimeField {
        ...
        public long roundFloor(long j) {
            if (j >= this.iCutover) {
                ...
                if (jRoundFloor < this.iCutover && GJChronology.this.iGapDuration + jRoundFloor < this.iCutover) {
                    return gregorianToJulian(jRoundFloor);
                }
                return jRoundFloor;
            }
        ...
        public long roundCeiling(long j) {
            ...
            if (jRoundCeiling >= this.iCutover && jRoundCeiling - GJChronology.this.iGapDuration >= this.iCutover) {
                return julianToGregorian(jRoundCeiling);
            }
    ...
    final class ImpreciseCutoverField extends CutoverField {
        ...
        public long add(long j, int i) {
            ...
            if (jAdd2 >= this.iCutover && jAdd2 - GJChronology.this.iGapDuration >= this.iCutover) {
                return julianToGregorian(jAdd2);
            }
            return jAdd2;
        }
