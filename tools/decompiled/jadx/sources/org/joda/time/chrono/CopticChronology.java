...
public final class CopticChronology extends BasicFixedMonthChronology {
    ...
    public static CopticChronology getInstance(DateTimeZone dateTimeZone, int i) {
        ...
        if (copticChronologyArr2 == null) {
            ...
            CopticChronology[] copticChronologyArrPutIfAbsent = cCache.putIfAbsent(dateTimeZone, copticChronologyArr3);
            copticChronologyArr = copticChronologyArrPutIfAbsent != null ? copticChronologyArrPutIfAbsent : copticChronologyArr3;
        } else {
