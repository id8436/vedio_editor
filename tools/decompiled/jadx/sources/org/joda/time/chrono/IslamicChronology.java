...
public final class IslamicChronology extends BasicChronology {
    ...
    public static IslamicChronology getInstance(DateTimeZone dateTimeZone, LeapYearPatternType leapYearPatternType) {
        ...
        if (islamicChronologyArr2 == null) {
            ...
            IslamicChronology[] islamicChronologyArrPutIfAbsent = cCache.putIfAbsent(dateTimeZone, islamicChronologyArr3);
            islamicChronologyArr = islamicChronologyArrPutIfAbsent != null ? islamicChronologyArrPutIfAbsent : islamicChronologyArr3;
        } else {
