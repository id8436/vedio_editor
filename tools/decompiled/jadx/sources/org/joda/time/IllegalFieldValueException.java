...
public class IllegalFieldValueException extends IllegalArgumentException {
    ...
    private static String createMessage(String str, Number number, Number number2, Number number3, String str2) {
        StringBuilder sbAppend = new StringBuilder().append("Value ").append(number).append(" for ").append(str).append(' ');
        if (number2 == null) {
            if (number3 == null) {
    ...
    private static String createMessage(String str, String str2) {
        ...
        stringBufferAppend.append(" for ").append(str).append(' ').append("is not supported");
