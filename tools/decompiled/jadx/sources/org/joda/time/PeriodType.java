...
public class PeriodType implements Serializable {
        ...
        if (durationFieldTypeArr != null) {
            if (durationFieldTypeArr.length != 0) {
                ...
                if (obj instanceof PeriodType) {
                    ...
                    PeriodType periodType3 = new PeriodType(null, periodTypeStandard.iTypes, null);
                    periodType = (PeriodType) map.get(periodType3);
                    if (periodType != null) {
                        map.put(periodType3, periodType);
                    } else {
                        map.put(periodType3, periodTypeStandard);
                        periodType = periodTypeStandard;
                    }
                }
            }
        }
    ...
    public int hashCode() {
        ...
        for (int i = 0; i < this.iTypes.length; i++) {
            iHashCode += this.iTypes[i].hashCode();
        }
        return iHashCode;
    }
}
