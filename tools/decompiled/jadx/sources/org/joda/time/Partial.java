...
public final class Partial extends AbstractPartial implements Serializable, ReadablePartial {
    ...
    public Partial(DateTimeFieldType dateTimeFieldType, int i, Chronology chronology) {
        ...
        chronologyWithUTC.validate(this, this.iValues);
    }
    ...
    public Partial with(DateTimeFieldType dateTimeFieldType, int i) {
        ...
        if (iIndexOf != -1) {
            return i != getValue(iIndexOf) ? new Partial(this, getField(iIndexOf).set(this, iIndexOf, getValues(), i)) : this;
        }
    ...
    public Partial without(DateTimeFieldType dateTimeFieldType) {
        ...
        if (iIndexOf != -1) {
            ...
            System.arraycopy(this.iTypes, iIndexOf + 1, dateTimeFieldTypeArr, iIndexOf, dateTimeFieldTypeArr.length - iIndexOf);
            System.arraycopy(this.iValues, 0, iArr, 0, iIndexOf);
            System.arraycopy(this.iValues, iIndexOf + 1, iArr, iIndexOf, iArr.length - iIndexOf);
