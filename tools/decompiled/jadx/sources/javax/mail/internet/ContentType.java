...
public class ContentType {
    ...
    public String getBaseType() {
        return new StringBuffer().append(this.primaryType).append(IOUtils.DIR_SEPARATOR_UNIX).append(this.subType).toString();
    }
    ...
    public String toString() {
        ...
        stringBuffer.append(this.primaryType).append(IOUtils.DIR_SEPARATOR_UNIX).append(this.subType);
        if (this.list != null) {
