...
final class a {
    public static X509Certificate[] a(X509Certificate[] x509CertificateArr, q qVar) throws CertificateException {
        boolean z = true;
        LinkedList linkedList = new LinkedList();
        boolean z2 = qVar.a(x509CertificateArr[0]);
        linkedList.add(x509CertificateArr[0]);
        boolean z3 = z2;
        int i = 1;
        while (i < x509CertificateArr.length) {
            if (qVar.a(x509CertificateArr[i])) {
                z3 = true;
            }
        ...
        X509Certificate x509CertificateB = qVar.b(x509CertificateArr[i - 1]);
