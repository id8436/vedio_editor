...
public class NotificationCompat {
    ...
    public class BuilderExtender {
        ...
        public Notification build(Builder builder, NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            RemoteViews remoteViewsMakeContentView = builder.mStyle != null ? builder.mStyle.makeContentView(notificationBuilderWithBuilderAccessor) : null;
            ...
            if (remoteViewsMakeContentView != null) {
                ...
                notificationBuild.contentView = builder.mContentView;
            }
            if (Build.VERSION.SDK_INT >= 16 && builder.mStyle != null && (remoteViewsMakeBigContentView = builder.mStyle.makeBigContentView(notificationBuilderWithBuilderAccessor)) != null) {
                notificationBuild.bigContentView = remoteViewsMakeBigContentView;
            }
            if (Build.VERSION.SDK_INT >= 21 && builder.mStyle != null && (remoteViewsMakeHeadsUpContentView = builder.mStyle.makeHeadsUpContentView(notificationBuilderWithBuilderAccessor)) != null) {
    ...
    class NotificationCompatApi16Impl extends NotificationCompatBaseImpl {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            ...
            Notification notificationBuild = builderExtender.build(builder, builder2);
            if (builder.mStyle != null && (extras = NotificationCompat.getExtras(notificationBuild)) != null) {
    ...
    class NotificationCompatApi20Impl extends NotificationCompatApi19Impl {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            ...
            Notification notificationBuild = builderExtender.build(builder, builder2);
            if (builder.mStyle != null) {
                builder.mStyle.addCompatExtras(NotificationCompat.getExtras(notificationBuild));
            }
            return notificationBuild;
        }
    ...
    public class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (Build.VERSION.SDK_INT >= 16) {
                ...
                for (int size = this.mMessages.size() - 1; size >= 0; size--) {
                    ...
                    CharSequence charSequenceMakeMessageLine = z ? makeMessageLine(message2) : message2.getText();
        ...
        private CharSequence makeMessageLine(Message message) {
            ...
            spannableStringBuilder.setSpan(makeFontColorSpan(i), spannableStringBuilder.length() - charSequenceUnicodeWrap.length(), spannableStringBuilder.length(), 33);
