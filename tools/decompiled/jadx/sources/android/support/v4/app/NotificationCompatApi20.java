...
class NotificationCompatApi20 {
    ...
    public class Builder implements NotificationBuilderWithActions, NotificationBuilderWithBuilderAccessor {
        ...
        private Notification.Builder f51b;
        ...
        public void addAction(NotificationCompatBase.Action action) {
            NotificationCompatApi20.addAction(this.f51b, action);
        }
        ...
        public Notification build() {
            this.f51b.setExtras(this.mExtras);
            Notification notificationBuild = this.f51b.build();
