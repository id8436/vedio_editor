...
class NotificationCompatApi21 {
    ...
    public class Builder implements NotificationBuilderWithActions, NotificationBuilderWithBuilderAccessor {
        ...
        public void addAction(NotificationCompatBase.Action action) {
            NotificationCompatApi20.addAction(this.f52b, action);
        }
        ...
        public Notification build() {
            ...
            Notification notificationBuild = this.f52b.build();
            ...
            if (this.mHeadsUpContentView != null) {
                notificationBuild.headsUpContentView = this.mHeadsUpContentView;
            }
