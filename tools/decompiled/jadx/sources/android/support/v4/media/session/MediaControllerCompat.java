...
public final class MediaControllerCompat {
    ...
    public static void setMediaController(@NonNull Activity activity, MediaControllerCompat mediaControllerCompat) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            Object objFromToken = null;
            if (mediaControllerCompat != null) {
                objFromToken = MediaControllerCompatApi21.fromToken(activity, mediaControllerCompat.getSessionToken().getToken());
            }
            MediaControllerCompatApi21.setMediaController(activity, objFromToken);
        }
    }
    ...
    class MediaControllerImplBase implements MediaControllerImpl {
        ...
        public boolean isShuffleModeEnabled() {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in isShuffleModeEnabled.", e2);
                return false;
            }
        }
    ...
    class TransportControlsBase extends TransportControls {
        ...
        public void setShuffleModeEnabled(boolean z) {
            try {
                ...
                Log.e(MediaControllerCompat.TAG, "Dead object in setShuffleModeEnabled.", e2);
            }
        }
