...
public final class MimeTypeFilter {
    ...
    public static boolean matches(@Nullable String str, @NonNull String str2) {
        ...
        return mimeTypeAgainstFilter(str.split(URIUtil.SLASH), str2.split(URIUtil.SLASH));
    }
    ...
    public static String matches(@Nullable String str, @NonNull String[] strArr) {
        ...
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(strArrSplit, str2.split(URIUtil.SLASH))) {
                return str2;
            }
        }
        return null;
    ...
    public static String matches(@Nullable String[] strArr, @NonNull String str) {
        ...
        String[] strArrSplit = str.split(URIUtil.SLASH);
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(str2.split(URIUtil.SLASH), strArrSplit)) {
                return str2;
            }
        }
        return null;
