...
public final class ResourcesCompat {
    ...
    private static Typeface loadFont(@NonNull Context context, int i, TypedValue typedValue, int i2, @Nullable TextView textView) {
        ...
        Typeface typefaceLoadFont = loadFont(context, resources, typedValue, i, i2, textView);
    ...
    private static Typeface loadFont(@NonNull Context context, Resources resources, TypedValue typedValue, int i, int i2, @Nullable TextView textView) {
        Typeface typefaceCreateFromResourcesFontFile;
            ...
            try {
                if (string.toLowerCase().endsWith(".xml")) {
                    ...
                    if (familyResourceEntry == null) {
                        ...
                        typefaceCreateFromResourcesFontFile = null;
                    } else {
                        typefaceCreateFromResourcesFontFile = TypefaceCompat.createFromResourcesFamilyXml(context, familyResourceEntry, resources, i, i2, textView);
                    }
                } else {
                    typefaceCreateFromResourcesFontFile = TypefaceCompat.createFromResourcesFontFile(context, resources, i, string, i2);
                }
                return typefaceCreateFromResourcesFontFile;
            } catch (IOException e2) {
                Log.e(TAG, "Failed to read xml resource " + string, e2);
                return null;
            } catch (XmlPullParserException e3) {
                Log.e(TAG, "Failed to parse xml resource " + string, e3);
                return null;
            }
        }
