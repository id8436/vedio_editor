...
public class FontResourcesParserCompat {
            ...
            if (typedArrayObtainTypedArray.length() > 0) {
                ...
                if (typedArrayObtainTypedArray.getResourceId(0, 0) != 0) {
                    for (int i2 = 0; i2 < typedArrayObtainTypedArray.length(); i2++) {
                        arrayList2.add(toByteArrayList(resources.getStringArray(typedArrayObtainTypedArray.getResourceId(i2, 0))));
                    }
    ...
    private static FontFileResourceEntry readFont(XmlPullParser xmlPullParser, Resources resources) throws XmlPullParserException, IOException {
        ...
        int i = typedArrayObtainAttributes.getInt(R.styleable.FontFamilyFont_fontWeight, 400);
        boolean z = 1 == typedArrayObtainAttributes.getInt(R.styleable.FontFamilyFont_fontStyle, 0);
        int resourceId = typedArrayObtainAttributes.getResourceId(R.styleable.FontFamilyFont_font, 0);
        String string = typedArrayObtainAttributes.getString(R.styleable.FontFamilyFont_font);
        typedArrayObtainAttributes.recycle();
        while (xmlPullParser.next() != 3) {
            skip(xmlPullParser);
        }
