...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingChild, NestedScrollingParent {
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mAnimateToCorrectPosition = new Animation() { // from class: android.support.v4.widget.SwipeRefreshLayout.6
            ...
            public void applyTransformation(float f2, Transformation transformation) {
                ...
                SwipeRefreshLayout.this.setTargetOffsetTopAndBottom((((int) ((iAbs - SwipeRefreshLayout.this.mFrom) * f2)) + SwipeRefreshLayout.this.mFrom) - SwipeRefreshLayout.this.mCircleView.getTop());
    ...
    private Animation startAlphaAnimation(final int i, final int i2) {
        Animation animation = new Animation() { // from class: android.support.v4.widget.SwipeRefreshLayout.4
            @Override // android.view.animation.Animation
            public void applyTransformation(float f2, Transformation transformation) {
                SwipeRefreshLayout.this.mProgress.setAlpha((int) (i + ((i2 - i) * f2)));
            }
        };
    ...
    private void moveSpinner(float f2) {
        ...
        float fMax2 = ((float) (((double) (Math.max(0.0f, Math.min(fAbs, f3 * 2.0f) / f3) / 4.0f)) - Math.pow(r3 / 4.0f, 2.0d))) * 2.0f;
        int i = ((int) ((f3 * fMin) + (f3 * fMax2 * 2.0f))) + this.mOriginalOffsetTop;
        ...
        this.mProgress.setProgressRotation(((-0.25f) + (fMax * 0.4f) + (fMax2 * 2.0f)) * DRAG_RATE);
        setTargetOffsetTopAndBottom(i - this.mCurrentTargetOffsetTop);
    }
    ...
    private void startDragging(float f2) {
        if (f2 - this.mInitialDownY > this.mTouchSlop && !this.mIsBeingDragged) {
    ...
    void moveToStart(float f2) {
        setTargetOffsetTopAndBottom((this.mFrom + ((int) ((this.mOriginalOffsetTop - this.mFrom) * f2))) - this.mCircleView.getTop());
    }
