...
public class AccessibilityNodeInfoCompat {
    ...
    public class RangeInfoCompat {
        ...
        public static RangeInfoCompat obtain(int i, float f2, float f3, float f4) {
            return new RangeInfoCompat(AccessibilityNodeInfoCompat.IMPL.obtainRangeInfo(i, f2, f3, f4));
        }
    ...
    class AccessibilityNodeInfoBaseImpl {
        ...
        public Object obtainRangeInfo(int i, float f2, float f3, float f4) {
            return null;
        }
    ...
    public List<AccessibilityNodeInfoCompat> findAccessibilityNodeInfosByViewId(String str) {
        List<AccessibilityNodeInfo> listFindAccessibilityNodeInfosByViewId = IMPL.findAccessibilityNodeInfosByViewId(this.mInfo, str);
