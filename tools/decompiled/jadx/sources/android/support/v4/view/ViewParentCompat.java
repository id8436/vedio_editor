...
public final class ViewParentCompat {
    ...
    @RequiresApi(19)
    class ViewParentCompatApi19Impl extends ViewParentCompatBaseImpl {
    ...
    @RequiresApi(21)
    class ViewParentCompatApi21Impl extends ViewParentCompatApi19Impl {
        ...
        public boolean onStartNestedScroll(ViewParent viewParent, View view, View view2, int i) {
            try {
                ...
                Log.e(ViewParentCompat.TAG, "ViewParent " + viewParent + " does not implement interface method onStartNestedScroll", e2);
                return false;
            }
        }
        ...
        public void onNestedScrollAccepted(ViewParent viewParent, View view, View view2, int i) {
            try {
                ...
                Log.e(ViewParentCompat.TAG, "ViewParent " + viewParent + " does not implement interface method onNestedScrollAccepted", e2);
            }
        }
        ...
        public void onStopNestedScroll(ViewParent viewParent, View view) {
            try {
                ...
                Log.e(ViewParentCompat.TAG, "ViewParent " + viewParent + " does not implement interface method onStopNestedScroll", e2);
            }
        }
        ...
        public void onNestedScroll(ViewParent viewParent, View view, int i, int i2, int i3, int i4) {
            try {
                ...
                Log.e(ViewParentCompat.TAG, "ViewParent " + viewParent + " does not implement interface method onNestedScroll", e2);
            }
        }
        ...
        public void onNestedPreScroll(ViewParent viewParent, View view, int i, int i2, int[] iArr) {
            try {
                ...
                Log.e(ViewParentCompat.TAG, "ViewParent " + viewParent + " does not implement interface method onNestedPreScroll", e2);
            }
        }
        ...
        public boolean onNestedFling(ViewParent viewParent, View view, float f2, float f3, boolean z) {
            try {
                ...
                Log.e(ViewParentCompat.TAG, "ViewParent " + viewParent + " does not implement interface method onNestedFling", e2);
                return false;
            }
        }
        ...
        public boolean onNestedPreFling(ViewParent viewParent, View view, float f2, float f3) {
            try {
                ...
                Log.e(ViewParentCompat.TAG, "ViewParent " + viewParent + " does not implement interface method onNestedPreFling", e2);
                return false;
            }
        }
    }
    ...
    public static boolean onNestedFling(ViewParent viewParent, View view, float f2, float f3, boolean z) {
        return IMPL.onNestedFling(viewParent, view, f2, f3, z);
    }
