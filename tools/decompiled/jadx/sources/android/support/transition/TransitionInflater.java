            ...
            if ((next != 3 || xmlPullParser.getDepth() > depth) && next != 1) {
                if (next == 2) {
                    if (xmlPullParser.getName().equals("target")) {
                        ...
                        int namedResourceId = TypedArrayUtils.getNamedResourceId(typedArrayObtainStyledAttributes, xmlPullParser, AdobePushNotificationPayloadKeys.ADOBE_PUSH_NOTIFICATION_TARGET_ID, 1, 0);
