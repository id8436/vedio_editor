...
public class AppBarLayout extends LinearLayout {
    ...
    int getDownNestedPreScrollRange() {
        ...
        while (childCount >= 0) {
            ...
            if ((i2 & 5) == 5) {
                ...
                if ((i2 & 8) != 0) {
                    topInset = i3 + ViewCompat.getMinimumHeight(childAt);
                } else if ((i2 & 2) != 0) {
                    topInset = i3 + (measuredHeight - ViewCompat.getMinimumHeight(childAt));
                } else {
    ...
    int getDownNestedScrollRange() {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            i += measuredHeight;
            if ((i3 & 2) != 0) {
                minimumHeight = i - (ViewCompat.getMinimumHeight(childAt) + getTopInset());
                break;
            }
        }
        minimumHeight = i;
    ...
    public class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        private void animateOffsetTo(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, int i, float f2) {
            int height;
        ...
        private void snapToChildIfNeeded(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout) {
            ...
            if (childIndexOnOffset >= 0) {
                ...
                if ((scrollFlags & 17) == 17) {
                    ...
                    int minimumHeight2 = -childAt.getBottom();
                    if (childIndexOnOffset == appBarLayout.getChildCount() - 1) {
                        minimumHeight2 += appBarLayout.getTopInset();
                    }
                    if (checkFlag(scrollFlags, 2)) {
                        minimumHeight2 += ViewCompat.getMinimumHeight(childAt);
                        minimumHeight = i;
                    } else if (checkFlag(scrollFlags, 5)) {
                        minimumHeight = ViewCompat.getMinimumHeight(childAt) + minimumHeight2;
                    ...
                    if (topBottomOffsetForScrollingSibling >= (minimumHeight2 + minimumHeight) / 2) {
                        minimumHeight2 = minimumHeight;
                    }
                    animateOffsetTo(coordinatorLayout, appBarLayout, MathUtils.clamp(minimumHeight2, -appBarLayout.getTotalScrollRange(), 0), 0.0f);
                }
            }
        }
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, int i) {
            ...
            if (this.mOffsetToChildIndexOnLayout >= 0 && (pendingAction & 8) == 0) {
                ...
                if (this.mOffsetToChildIndexOnLayoutIsMinHeight) {
                    iRound = ViewCompat.getMinimumHeight(childAt) + appBarLayout.getTopInset() + i2;
                } else {
                    iRound = Math.round(childAt.getHeight() * this.mOffsetToChildIndexOnLayoutPerc) + i2;
                }
        ...
        public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, int i, int i2, int i3) {
            ...
            if (i2 != 0 && topBottomOffsetForScrollingSibling >= i2 && topBottomOffsetForScrollingSibling <= i3) {
                ...
                int i4 = topBottomOffsetForScrollingSibling - iClamp;
