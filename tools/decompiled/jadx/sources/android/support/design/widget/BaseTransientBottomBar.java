...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
            ...
            valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: android.support.design.widget.BaseTransientBottomBar.8
                ...
                public void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    ...
                    if (BaseTransientBottomBar.USE_OFFSET_API) {
                        ViewCompat.offsetTopAndBottom(BaseTransientBottomBar.this.mView, iIntValue - this.mPreviousAnimatedIntValue);
                    } else {
                        BaseTransientBottomBar.this.mView.setTranslationY(iIntValue);
                    }
                    this.mPreviousAnimatedIntValue = iIntValue;
                }
            });
            valueAnimator.start();
            return;
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    class SnackbarBaseLayout extends FrameLayout {
