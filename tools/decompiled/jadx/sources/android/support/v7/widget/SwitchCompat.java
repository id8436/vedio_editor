...
public class SwitchCompat extends CompoundButton {
    ...
    private boolean hitThumb(float f2, float f3) {
        ...
        return f2 > ((float) i2) && f2 < ((float) ((((this.mThumbWidth + i2) + this.mTempRect.left) + this.mTempRect.right) + this.mTouchSlop)) && f3 > ((float) i) && f3 < ((float) (this.mSwitchBottom + this.mTouchSlop));
    }
