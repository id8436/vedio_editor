...
public class RecyclerView extends ViewGroup implements NestedScrollingChild2, ScrollingView {
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attributeSet, int i) throws NoSuchMethodException {
    ...
    public boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (this.mLayout != null && !this.mLayoutFrozen && motionEvent.getAction() == 8) {
            ...
            if (f2 != 0.0f || axisValue != 0.0f) {
                scrollByInternal((int) (axisValue * this.mScaledHorizontalScrollFactor), (int) (this.mScaledVerticalScrollFactor * f2), motionEvent);
            }
        }
        return false;
    }
    ...
    */
    ...
    class ViewFlinger implements Runnable {
        ...
        private int computeScrollDuration(int i, int i2, int i3, int i4) {
            ...
            int i5 = width / 2;
            float fDistanceInfluenceForSnapDuration = (distanceInfluenceForSnapDuration(Math.min(1.0f, (iSqrt2 * 1.0f) / width)) * i5) + i5;
            if (iSqrt > 0) {
                iRound = Math.round(1000.0f * Math.abs(fDistanceInfluenceForSnapDuration / iSqrt)) * 4;
            } else {
    ...
    public final class Recycler {
        ...
        ViewHolder tryGetViewHolderForPositionByDeadline(int i, boolean z, long j) {
            ...
            if (RecyclerView.this.mState.isPreLayout() && viewHolder.isBound()) {
                ...
                zTryBindViewHolderByDeadline = (!viewHolder.isBound() || viewHolder.needsUpdate() || viewHolder.isInvalid()) ? tryBindViewHolderByDeadline(viewHolder, RecyclerView.this.mAdapterHelper.findPositionOffset(i), i, j) : false;
            }
  ...
  0x007a: PHI (r0v9 int) = (r0v4 int), (r0v14 int) binds: [B:20:0x0066, B:14:0x0035] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public class State {
        ...
        public String toString() {
            return "State{mTargetPosition=" + this.mTargetPosition + ", mData=" + this.mData + ", mItemCount=" + this.mItemCount + ", mPreviousLayoutItemCount=" + this.mPreviousLayoutItemCount + ", mDeletedInvisibleItemCountSincePreviousLayout=" + this.mDeletedInvisibleItemCountSincePreviousLayout + ", mStructureChanged=" + this.mStructureChanged + ", mInPreLayout=" + this.mInPreLayout + ", mRunSimpleAnimations=" + this.mRunSimpleAnimations + ", mRunPredictiveAnimations=" + this.mRunPredictiveAnimations + Category.SCHEME_SUFFIX;
        }
    }
