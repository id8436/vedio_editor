    ...
    */
        ...
        if (this.mSecondaryOrientation.getMode() != 1073741824) {
            ...
            while (i < childCount) {
                ...
                if (decoratedMeasurement < f2) {
                    ...
                    fMax = Math.max(f2, ((LayoutParams) childAt.getLayoutParams()).isFullSpan() ? (1.0f * decoratedMeasurement) / this.mSpanCount : decoratedMeasurement);
                }
                i++;
                f2 = fMax;
            }
            int i2 = this.mSizePerSpan;
            int iRound = Math.round(this.mSpanCount * f2);
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (layoutState.hasMore(state) && (this.mLayoutState.mInfinite || !this.mRemainingSpans.isEmpty())) {
            ...
            if (layoutState.mLayoutDirection == 1) {
                ...
                decoratedMeasurement2 = maxEnd2 + this.mPrimaryOrientation.getDecoratedMeasurement(next);
            ...
            if (isLayoutRTL() && this.mOrientation == 1) {
                ...
                decoratedMeasurement3 = startAfterPadding2 + this.mSecondaryOrientation.getDecoratedMeasurement(next);
                decoratedMeasurement4 = startAfterPadding2;
            }
            if (this.mOrientation == 1) {
                layoutDecoratedWithMargins(next, decoratedMeasurement4, decoratedMeasurement, decoratedMeasurement3, decoratedMeasurement2);
            } else {
                layoutDecoratedWithMargins(next, decoratedMeasurement, decoratedMeasurement4, decoratedMeasurement2, decoratedMeasurement3);
            }
            if (layoutParams.mFullSpan) {
    ...
    class LazySpanLookup {
        ...
        int invalidateAfter(int i) {
            ...
            Arrays.fill(this.mData, i, iInvalidateFullSpansAfter + 1, -1);
            return iInvalidateFullSpansAfter + 1;
        }
        ...
        class FullSpanItem implements Parcelable {
            ...
            public String toString() {
                return "FullSpanItem{mPosition=" + this.mPosition + ", mGapDir=" + this.mGapDir + ", mHasUnwantedGapAfter=" + this.mHasUnwantedGapAfter + ", mGapPerSpan=" + Arrays.toString(this.mGapPerSpan) + Category.SCHEME_SUFFIX;
            }
        }
    }
