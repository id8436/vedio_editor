...
class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    boolean isPointInsideHorizontalThumb(float f2, float f3) {
        return f3 >= ((float) (this.mRecyclerViewHeight - this.mHorizontalThumbHeight)) && f2 >= ((float) (this.mHorizontalThumbCenterX - (this.mHorizontalThumbWidth / 2))) && f2 <= ((float) (this.mHorizontalThumbCenterX + (this.mHorizontalThumbWidth / 2)));
    }
