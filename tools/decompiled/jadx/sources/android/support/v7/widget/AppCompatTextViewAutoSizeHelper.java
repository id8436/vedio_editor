...
class AppCompatTextViewAutoSizeHelper {
    ...
    private boolean suggestedSizeFitsInSpace(int i, RectF rectF) {
        ...
        if (maxLines == -1 || (staticLayoutCreateStaticLayoutForMeasuringPre23.getLineCount() <= maxLines && staticLayoutCreateStaticLayoutForMeasuringPre23.getLineEnd(staticLayoutCreateStaticLayoutForMeasuringPre23.getLineCount() - 1) == text.length())) {
            return ((float) staticLayoutCreateStaticLayoutForMeasuringPre23.getHeight()) <= rectF.bottom;
        }
        return false;
    }
