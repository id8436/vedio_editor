...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    class ChangeInfo {
        ...
        public String toString() {
            return "ChangeInfo{oldHolder=" + this.oldHolder + ", newHolder=" + this.newHolder + ", fromX=" + this.fromX + ", fromY=" + this.fromY + ", toX=" + this.toX + ", toY=" + this.toY + Category.SCHEME_SUFFIX;
        }
    }
