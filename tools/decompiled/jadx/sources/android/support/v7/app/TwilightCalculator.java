...
class TwilightCalculator {
    ...
    public void calculateTwilight(long j, double d2, double d3) {
        float f2 = 6.24006f + (0.01720197f * ((j - UTC_2000) / 8.64E7f));
        double dSin = ((double) f2) + (0.03341960161924362d * Math.sin(f2)) + (3.4906598739326E-4d * Math.sin(2.0f * f2)) + (5.236000106378924E-6d * Math.sin(3.0f * f2)) + 1.796593063d + 3.141592653589793d;
        double dSin2 = (Math.sin(f2) * 0.0053d) + ((-d3) / 360.0d) + ((double) (Math.round(((double) (r2 - J0)) - r6) + J0)) + ((-0.0069d) * Math.sin(2.0d * dSin));
