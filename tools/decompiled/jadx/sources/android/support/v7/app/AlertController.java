    ...
    private void setupView() {
        ...
        if (z2) {
            ...
            if (this.mMessage != null || this.mListView != null) {
                viewFindViewById10 = viewGroupResolvePanel.findViewById(R.id.titleDividerNoCustom);
            }
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (this.mIsMultiChoice) {
                if (this.mCursor == null) {
                    checkedItemAdapter = new ArrayAdapter<CharSequence>(this.mContext, alertController.mMultiChoiceItemLayout, i2, this.mItems) { // from class: android.support.v7.app.AlertController.AlertParams.1
                    ...
                    checkedItemAdapter = new CursorAdapter(this.mContext, this.mCursor, z) { // from class: android.support.v7.app.AlertController.AlertParams.2
