...
final class AppCompatColorStateListInflater {
    ...
    private static ColorStateList inflate(@NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next == 2 && depth <= depth2 && xmlPullParser.getName().equals(DocumentListEntry.LABEL)) {
                ...
                int[] iArrAppend = GrowingArrayUtils.append(iArr3, i2, iModulateColorAlpha);
    ...
    private static int modulateColorAlpha(int i, float f2) {
        return ColorUtils.setAlphaComponent(i, Math.round(Color.alpha(i) * f2));
    }
}
