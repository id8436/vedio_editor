...
final class MultiDexExtractor {
        ...
        try {
            ...
            while (entry != null) {
                ...
                while (i2 < 3 && !z) {
                    ...
                    Log.i(TAG, "Extraction " + (zVerifyZipFile ? AdobeAnalyticsETSEvent.ADOBE_ETS_VALUE_ERROR_CODE_SUCCESS : "failed") + " - length " + file3.getAbsolutePath() + ": " + file3.length());
                    if (!zVerifyZipFile) {
                        file3.delete();
                        if (file3.exists()) {
    ...
    static boolean verifyZipFile(File file) {
        try {
            ...
            Log.w(TAG, "File " + file.getAbsolutePath() + " is not a valid zip file.", e4);
        }
    }
